...
!function(e, t, n, i) {
  e.site=e.fn.site=function(o) {
    let a; let r; let s=(new Date).getTime(); let l=[]; const c=arguments[0]; const u='string'==typeof c; const d=[].slice.call(arguments, 1); const f=e.isPlainObject(o)?e.extend(!0, {}, e.site.settings, o):e.extend({}, e.site.settings); const m=f.namespace; const g=f.error; const p='module-'+m; const h=e(n); const v=this; let b=h.data(p); return a={initialize: function() {
      a.instantiate();
      ...
      const n=[]; return t=t||f.modules, e.each(t, function(e, t) {
      ...
      o='string'==typeof o?'all'===o?f.modules:[o]:o||f.modules, r=r===i||r, e.each(o, function(i, o) {
        let s; const l=!a.moduleExists(o)||(e.fn[o].settings.namespace||!1); a.moduleExists(o)&&(a.verbose('Changing default setting', t, n, o), e.fn[o].settings[t]=n, r&&l&&(s=e(':data(module-'+l+')')).length>0&&(a.verbose('Modifying existing settings', s), s[o]('setting', t, n)));
      });
    }, settings: function(t, n, o) {
      n='string'==typeof n?[n]:n||f.modules, o=o===i||o, e.each(n, function(n, i) {
        let r; a.moduleExists(i)&&(a.verbose('Changing default setting', t, i), e.extend(!0, e.fn[i].settings, t), o&&m&&(r=e(':data(module-'+m+')')).length>0&&(a.verbose('Modifying existing settings', r), r[i]('setting', t)));
      });
      ...
      let t; let n; f.performance&&(n=(t=(new Date).getTime())-(s||t), s=t, l.push({'Element': v, 'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Execution Time': n})), clearTimeout(a.performance.timer), a.performance.timer=setTimeout(a.performance.display, 500);
    }, display: function() {
      let t=f.name+':'; let n=0; s=!1, clearTimeout(a.performance.timer), e.each(l, function(e, t) {
        n+=t['Execution Time'];
      ...
      let s; let l; let c; let u=b; return n=n||d, o=v||o, 'string'==typeof t&&u!==i&&(t=t.split(/[\. ]/), s=t.length-1, e.each(t, function(n, o) {
        const r=n!=s?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(u[r])&&n!=s)u=u[r]; else {
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.form=function(t) {
    let o; const a=e(this); const r=a.selector||''; let s=(new Date).getTime(); let l=[]; const c=arguments[0]; const u=arguments[1]; const d='string'==typeof c; const f=[].slice.call(arguments, 1); return a.each(function() {
      let m; let g; let p; let h; let v; let b; let y; let x; let C; let w; let S; let k; let T; let A; let R; let P; const E=e(this); const F=this; let O=[]; let D=!1; (P={initialize: function() {
        ...
        P.verbose('Attaching form events'), E.on('submit'+A, P.validate.form).on('blur'+A, x.field, P.event.field.blur).on('click'+A, x.submit, P.submit).on('click'+A, x.reset, P.reset).on('click'+A, x.clear, P.clear), v.keyboardShortcuts&&E.on('keydown'+A, x.field, P.event.field.keydown), m.each(function() {
          const t=e(this); const n=t.prop('type'); const i=P.get.changeEvent(n, t); e(this).on(i+A, P.event.field.change);
        });
      }, clear: function() {
        m.each(function() {
          const t=e(this); const n=t.parent(); const i=t.closest(g); const o=i.find(x.prompt); const a=t.data(y.defaultValue)||''; const r=n.is(x.uiCheckbox); const s=n.is(x.uiDropdown); i.hasClass(C.error)&&(P.verbose('Resetting error on field', i), i.removeClass(C.error), o.remove()), s?(P.verbose('Resetting dropdown value', n, a), n.dropdown('clear')):r?t.prop('checked', !1):(P.verbose('Resetting field value', t, a), t.val(''));
        });
      }, reset: function() {
        m.each(function() {
          const t=e(this); const n=t.parent(); const o=t.closest(g); const a=o.find(x.prompt); const r=t.data(y.defaultValue); const s=n.is(x.uiCheckbox); const l=n.is(x.uiDropdown); const c=o.hasClass(C.error); r!==i&&(c&&(P.verbose('Resetting error on field', o), o.removeClass(C.error), a.remove()), l?(P.verbose('Resetting dropdown value', n, r), n.dropdown('restore defaults')):s?(P.verbose('Resetting checkbox value', n, r), t.prop('checked', r)):(P.verbose('Resetting field value', t, r), t.val(r)));
        });
      }, determine: {isValid: function() {
        let t=!0; return e.each(b, function(e, n) {
        ...
        const t=e[Object.keys(e)[0]]; return P.is.shorthandRules(t);
        ...
        let n=!0; return t?(P.verbose('Checking if field is valid', t), P.validate.field(b[t], t, !1)):(P.verbose('Checking if form is valid'), e.each(b, function(e, t) {
          P.is.valid(e)||(n=!1);
        }), n);
      }}, removeEvents: function() {
        E.off(A), m.off(A), h.off(A), m.off(A);
      }, event: {field: {keydown: function(t) {
        const n=e(this); const i=t.which; const o=n.is(x.input); const a=n.is(x.checkbox); const r=n.closest(x.uiDropdown).length>0; const s=13; i==27&&(P.verbose('Escape key pressed blurring field'), n.blur()), t.ctrlKey||i!=s||!o||r||a||(D||(n.one('keyup'+A, P.event.field.keyup), P.submit(), P.debug('Enter pressed on input submitting form')), D=!0);
      }, keyup: function() {
        D=!1;
      }, blur: function(t) {
        const n=e(this); const i=n.closest(g); const o=P.get.validation(n); i.hasClass(C.error)?(P.debug('Revalidating field', n, o), o&&P.validate.field(o)):'blur'==v.on&&o&&P.validate.field(o);
      }, change: function(t) {
        const n=e(this); const i=n.closest(g); const o=P.get.validation(n); o&&('change'==v.on||i.hasClass(C.error)&&v.revalidate)&&(clearTimeout(P.timer), P.timer=setTimeout(function() {
        ...
        const n={}; return e.each(t, function(t, i) {
          'string'==typeof i&&(i=[i]), n[t]={rules: []}, e.each(i, function(e, i) {
            n[t].rules.push({type: i});
          });
        }), n;
      }, prompt: function(t, n) {
        let i; let o; const a=P.get.ruleName(t); const r=P.get.ancillaryValue(t); const s=P.get.field(n.identifier); const l=s.val(); let c=e.isFunction(t.prompt)?t.prompt(l):t.prompt||v.prompt[a]||v.text.unspecifiedRule; const u=-1!==c.search('{value}'); const d=-1!==c.search('{name}'); return u&&(c=c.replace('{value}', s.val())), d&&(o=1==(i=s.closest(x.group).find('label').eq(0)).length?i.text():s.prop('placeholder')||v.text.unspecifiedField, c=c.replace('{name}', o)), c=(c=c.replace('{identifier}', n.identifier)).replace('{ruleValue}', r), t.prompt||P.verbose('Using default validation prompt for type', c, a), c;
      }, settings: function() {
        if (e.isPlainObject(t)) {
          const n=Object.keys(t); n.length>0&&(t[n[0]].identifier!==i&&t[n[0]].rules!==i)?(v=e.extend(!0, {}, e.fn.form.settings, u), b=e.extend({}, e.fn.form.settings.defaults, t), P.error(v.error.oldSyntax, F), P.verbose('Extending settings from legacy parameters', b, v)):(t.fields&&P.is.shorthandFields(t.fields)&&(t.fields=P.get.fieldsFromShorthand(t.fields)), v=e.extend(!0, {}, e.fn.form.settings, t), b=e.extend({}, e.fn.form.settings.defaults, v.fields), P.verbose('Extending settings', b, v));
        ...
        let n=e(); return e.each(t, function(e, t) {
          n=n.add(P.get.field(t));
        }), n;
      }, validation: function(t) {
        let n; let i; return !!b&&(e.each(b, function(e, o) {
          i=o.identifier||e, P.get.field(i)[0]==t[0]&&(o.identifier=i, n=o);
        }), n||!1);
      }, value: function(e) {
        const t=[]; return t.push(e), P.get.values.call(F, t)[e];
      }, values: function(t) {
        const n={}; return (e.isArray(t)?P.get.fields(t):m).each(function(t, o) {
          const a=e(o); let r=(a.prop('type'), a.prop('name')); const s=a.val(); const l=a.is(x.checkbox); const c=a.is(x.radio); const u=-1!==r.indexOf('[]'); const d=!!l&&a.is(':checked'); r&&(u?(r=r.replace('[]', ''), n[r]||(n[r]=[]), l?d?n[r].push(s||!0):n[r].push(!1):n[r].push(s)):c?n[r]!==i&&0!=n[r]||(n[r]=!!d&&(s||!0)):n[r]=l?!!d&&(s||!0):s);
        }), n;
...
e.isArray(t)?e.each(fields, function(e, t) {
  P.remove.rule(t, n);
        ...
        const n=P.get.field(t).closest(g); const o=n.children(x.prompt); n.removeClass(C.error), v.inline&&o.is(':visible')&&(P.verbose('Removing prompt for field', t), v.transition&&e.fn.transition!==i&&E.transition('is supported')?o.transition(v.transition+' out', v.duration, function() {
          o.remove();
        ...
        m.each(function() {
          const t=e(this); const n=t.filter(x.checkbox).length>0?t.is(':checked'):t.val(); t.data(y.defaultValue, n);
        });
      }, error: function() {
        E.removeClass(C.success).addClass(C.error);
      }, value: function(e, t) {
        const n={}; return n[e]=t, P.set.values.call(F, n);
      }, values: function(t) {
        e.isEmptyObject(t)||e.each(t, function(t, n) {
          let i; const o=P.get.field(t); let a=o.parent(); const r=e.isArray(n); const s=a.is(x.uiCheckbox); const l=a.is(x.uiDropdown); const c=o.is(x.radio)&&s; o.length>0&&(r&&s?(P.verbose('Selecting multiple', n, o), a.checkbox('uncheck'), e.each(n, function(e, t) {
        ...
        const n=P.get.values(); if (D) return !1; if (O=[], P.determine.isValid()) {
        ...
        o=o===i||o, 'string'==typeof t&&(P.verbose('Validating field', t), n=t, t=b[t]); const a=t.identifier||n; const r=P.get.field(a); const s=!!t.depends&&P.get.field(t.depends); let l=!0; const c=[]; return t.identifier||(P.debug('Using field name as identifier', a), t.identifier=a), r.prop('disabled')?(P.debug('Field is disabled. Skipping', a), l=!0):t.optional&&P.is.blank(r)?(P.debug('Field is optional and blank. Skipping', a), l=!0):t.depends&&P.is.empty(s)?(P.debug('Field depends on another value that is not present or empty. Skipping', s), l=!0):t.rules!==i&&e.each(t.rules, function(e, n) {
        ...
        const o=P.get.field(t.identifier); let a=(n.type, o.val()); const r=P.get.ancillaryValue(n); const s=P.get.ruleName(n); const l=v.rules[s]; if (e.isFunction(l)) return a=a===i||''===a||null===a?'':e.trim(a+''), l.call(o, a, r); P.error(S.noRule, s);
        ...
        let t; let n; v.performance&&(n=(t=(new Date).getTime())-(s||t), s=t, l.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': F, 'Execution Time': n})), clearTimeout(P.performance.timer), P.performance.timer=setTimeout(P.performance.display, 500);
      }, display: function() {
        let t=v.name+':'; let n=0; s=!1, clearTimeout(P.performance.timer), e.each(l, function(e, t) {
          n+=t['Execution Time'];
        ...
        let r; let s; let l; let c=R; return n=n||f, a=F||a, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
    ...
    let n='<ul class="list">'; return e.each(t, function(e, t) {
      n+='<li>'+t+'</li>';
    }), e(n+='</ul>');
  }, prompt: function(t) {
    ...
    if (n instanceof RegExp) return t.match(n); let i; const o=n.match(e.fn.form.settings.regExp.flags); return o&&(n=o.length>=2?o[1]:n, i=o.length>=3?o[2]:''), t.match(new RegExp(n, i));
  }, integer: function(t, n) {
    let o; let a; let r; const s=e.fn.form.settings.regExp.integer; return n&&-1===['', '..'].indexOf(n)&&(-1==n.indexOf('..')?s.test(n)&&(o=a=n-0):(r=n.split('..', 2), s.test(r[0])&&(o=r[0]-0), s.test(r[1])&&(a=r[1]-0))), s.test(t)&&(o===i||t>=o)&&(a===i||t<=a);
  }, decimal: function(t) {
    ...
    let o; e(this); return e('[data-validate="'+n+'"]').length>0?o=e('[data-validate="'+n+'"]').val():e('#'+n).length>0?o=e('#'+n).val():e('[name="'+n+'"]').length>0?o=e('[name="'+n+'"]').val():e('[name="'+n+'[]"]').length>0&&(o=e('[name="'+n+'[]"]')), o!==i&&t.toString()==o.toString();
  }, different: function(t, n) {
    let o; e(this); return e('[data-validate="'+n+'"]').length>0?o=e('[data-validate="'+n+'"]').val():e('#'+n).length>0?o=e('#'+n).val():e('[name="'+n+'"]').length>0?o=e('[name="'+n+'"]').val():e('[name="'+n+'[]"]').length>0&&(o=e('[name="'+n+'[]"]')), o!==i&&t.toString()!==o.toString();
  }, creditCard: function(t, n) {
    let i; let o; const a={visa: {pattern: /^4/, length: [16]}, amex: {pattern: /^3[47]/, length: [15]}, mastercard: {pattern: /^5[1-5]/, length: [16]}, discover: {pattern: /^(6011|622(12[6-9]|1[3-9][0-9]|[2-8][0-9]{2}|9[0-1][0-9]|92[0-5]|64[4-9])|65)/, length: [16]}, unionPay: {pattern: /^(62|88)/, length: [16, 17, 18, 19]}, jcb: {pattern: /^35(2[89]|[3-8][0-9])/, length: [16]}, maestro: {pattern: /^(5018|5020|5038|6304|6759|676[1-3])/, length: [12, 13, 14, 15, 16, 17, 18, 19]}, dinersClub: {pattern: /^(30[0-5]|^36)/, length: [14]}, laser: {pattern: /^(6304|670[69]|6771)/, length: [16, 17, 18, 19]}, visaElectron: {pattern: /^(4026|417500|4508|4844|491(3|7))/, length: [16]}}; let r={}; let s=!1; const l='string'==typeof n&&n.split(','); if ('string'==typeof t&&0!==t.length) {
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.accordion=function(n) {
    let o; const a=e(this); let r=(new Date).getTime(); let s=[]; const l=arguments[0]; const c='string'==typeof l; const u=[].slice.call(arguments, 1); t.requestAnimationFrame||t.mozRequestAnimationFrame||t.webkitRequestAnimationFrame||t.msRequestAnimationFrame; return a.each(function() {
      let d; let f; const m=e.isPlainObject(n)?e.extend(!0, {}, e.fn.accordion.settings, n):e.extend({}, e.fn.accordion.settings); const g=m.className; const p=m.namespace; const h=m.selector; const v=m.error; const b='.'+p; const y='module-'+p; const x=a.selector||''; const C=e(this); let w=C.find(h.title); let S=C.find(h.content); const k=this; let T=C.data(y); f={initialize: function() {
        ...
        const n=t!==i?'number'==typeof t?w.eq(t):e(t).closest(h.title):e(this).closest(h.title); const o=n.next(S); const a=o.hasClass(g.animating); const r=o.hasClass(g.active); const s=r&&!a; const l=!r&&a; f.debug('Toggling visibility of content', n), s||l?m.collapsible?f.close.call(n):f.debug('Cannot close accordion content collapsing is disabled'):f.open.call(n);
      }, open: function(t) {
        ...
        let n; let o; let a; const r=t!==i?w.eq(t):e(this).closest(h.title); const s=r.parents(h.content).prev(h.title); const l=r.closest(h.accordion); const c=h.title+'.'+g.active+':visible'; const u=h.content+'.'+g.active+':visible'; m.closeNested?a=(n=l.find(c).not(s)).next(S):(n=l.find(c).not(s), o=l.find(u).find(c).not(s), a=(n=n.not(o)).next(S)), n.length>0&&(f.debug('Exclusive enabled, closing other content', n), n.removeClass(g.active), a.removeClass(g.animating).stop(!0, !0), m.animateChildren&&(e.fn.transition!==i&&C.transition('is supported')?a.children().transition({animation: 'fade out', useFailSafe: !0, debug: m.debug, verbose: m.verbose, duration: m.duration}):a.children().stop(!0, !0).animate({opacity: 0}, m.duration, f.resetOpacity)), a.slideUp(m.duration, m.easing, function() {
        ...
        let t; let n; m.performance&&(n=(t=(new Date).getTime())-(r||t), r=t, s.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': k, 'Execution Time': n})), clearTimeout(f.performance.timer), f.performance.timer=setTimeout(f.performance.display, 500);
      }, display: function() {
        let t=m.name+':'; let n=0; r=!1, clearTimeout(f.performance.timer), e.each(s, function(e, t) {
          n+=t['Execution Time'];
        ...
        let r; let s; let l; let c=T; return n=n||u, a=k||a, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.checkbox=function(o) {
    let a; const r=e(this); const s=r.selector||''; let l=(new Date).getTime(); let c=[]; const u=arguments[0]; const d='string'==typeof u; const f=[].slice.call(arguments, 1); return r.each(function() {
      let r; let m; const g=e.extend(!0, {}, e.fn.checkbox.settings, o); const p=g.className; const h=g.namespace; const v=g.selector; const b=g.error; const y='.'+h; const x='module-'+h; let C=e(this); let w=e(this).children(v.label); let S=e(this).children(v.input); let k=S[0]; let T=!1; let A=!1; let R=C.data(x); const P=this; m={initialize: function() {
        ...
        const i=e(t); n=e.isFunction(m[n])?m[n]:m.toggle, i.length>0?(m.debug('Attaching checkbox events to element', t, n), i.on('click'+y, n)):m.error(b.notFound);
      }, event: {click: function(t) {
        const n=e(t.target); n.is(v.input)?m.verbose('Using default check action on initialized checkbox'):n.is(v.link)?m.debug('Clicking link inside checkbox, skipping toggle'):(m.toggle(), S.focus(), t.preventDefault());
      }, keydown: function(e) {
        const t=e.which; const n=13; const i=32; t==27?(m.verbose('Escape key pressed blurring field'), S.blur(), A=!0):e.ctrlKey||t!=i&&t!=n?A=!1:(m.verbose('Enter/space key pressed, toggling checkbox'), m.toggle(), A=!0);
      }, keyup: function(e) {
        A&&e.preventDefault();
      }}, check: function() {
...
m.is.disabled()?m.debug('Checkbox is already disabled'):(m.debug('Disabling checkbox'), m.set.disabled(), g.onDisable.call(k), g.onDisabled.call(k));
        ...
        const t=m.get.name(); return e('input[name="'+t+'"]').closest(v.checkbox);
        ...
        const e=n.createEvent('HTMLEvents'); const t=S[0]; t&&(m.verbose('Triggering native change event'), e.initEvent('change', !0, !1), t.dispatchEvent(e));
...
S.prevAll(v.label).length>0?(S.prev(v.label).detach().insertAfter(S), m.debug('Moving existing label', w)):m.has.label()||(w=e('<label>').insertAfter(S), m.debug('Creating label', w));
        ...
        const e=m.get.otherRadios(); m.debug('Unchecking other radios', e), e.removeClass(p.checked);
      }, toggle: function() {
m.can.change()?m.is.indeterminate()||m.is.unchecked()?(m.debug('Currently unchecked'), m.check()):m.is.checked()&&m.can.uncheck()&&(m.debug('Currently checked'), m.uncheck()):m.is.radio()||m.debug('Checkbox is read-only or disabled, ignoring toggle');
        ...
        let t; let n; g.performance&&(n=(t=(new Date).getTime())-(l||t), l=t, c.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': P, 'Execution Time': n})), clearTimeout(m.performance.timer), m.performance.timer=setTimeout(m.performance.display, 500);
      }, display: function() {
        let t=g.name+':'; let n=0; l=!1, clearTimeout(m.performance.timer), e.each(c, function(e, t) {
          n+=t['Execution Time'];
        ...
        let r; let s; let l; let c=R; return n=n||f, o=P||o, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.dimmer=function(t) {
    let o; const a=e(this); let r=(new Date).getTime(); let s=[]; const l=arguments[0]; const c='string'==typeof l; const u=[].slice.call(arguments, 1); return a.each(function() {
      let d; let f; let m; const g=e.isPlainObject(t)?e.extend(!0, {}, e.fn.dimmer.settings, t):e.extend({}, e.fn.dimmer.settings); const p=g.selector; const h=g.namespace; const v=g.className; const b=g.error; const y='.'+h; const x='module-'+h; const C=a.selector||''; const w='ontouchstart'in n.documentElement?'touchstart':'click'; const S=e(this); const k=this; let T=S.data(x); (m={preinitialize: function() {
m.is.dimmer()?(f=S.parent(), d=S):(f=S, d=m.has.dimmer()?g.dimmerName?f.find(p.dimmer).filter('.'+g.dimmerName):f.find(p.dimmer):m.create(), m.set.variation());
        ...
        const n=e(t); m.debug('Add content to dimmer', n), n.parent()[0]!==d[0]&&n.detach().appendTo(d);
      }, create: function() {
        const t=e(g.template.dimmer()); return g.dimmerName&&(m.debug('Creating named dimmer', g.dimmerName), t.addClass(g.dimmerName)), t.appendTo(f), t;
      }, show: function(t) {
        ...
        let t=d.css('background-color'); const n=t.split(','); const i=n&&3==n.length; const o=n&&4==n.length; e=0===g.opacity?0:g.opacity||e, i||o?(n[3]=e+')', t=n.join(',')):t='rgba(0, 0, 0, '+e+')', m.debug('Setting opacity to', e), d.css('background-color', t);
      }, active: function() {
        d.addClass(v.active);
      }, dimmable: function() {
        ...
        let t; let n; g.performance&&(n=(t=(new Date).getTime())-(r||t), r=t, s.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': k, 'Execution Time': n})), clearTimeout(m.performance.timer), m.performance.timer=setTimeout(m.performance.display, 500);
      }, display: function() {
        let t=g.name+':'; let n=0; r=!1, clearTimeout(m.performance.timer), e.each(s, function(e, t) {
          n+=t['Execution Time'];
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.dropdown=function(o) {
    let a; let r=e(this); const s=e(n); const l=r.selector||''; const c='ontouchstart'in n.documentElement; let u=(new Date).getTime(); let d=[]; const f=arguments[0]; const m='string'==typeof f; const g=[].slice.call(arguments, 1); return r.each(function(p) {
      let h; let v; let b; let y; let x; let C; let w; let S; const k=e.isPlainObject(o)?e.extend(!0, {}, e.fn.dropdown.settings, o):e.extend({}, e.fn.dropdown.settings); const T=k.className; const A=k.message; const R=k.fields; const P=k.keys; const E=k.metadata; const F=k.namespace; const O=k.regExp; const D=k.selector; const q=k.error; const j=k.templates; const z='.'+F; const I='module-'+F; let M=e(this); const L=e(k.context); let V=M.find(D.text); let N=M.find(D.search); let H=M.find(D.sizer); let U=M.find(D.input); let W=M.find(D.icon); let B=M.prev().find(D.text).length>0?M.prev().find(D.text):M.prev(); let Q=M.children(D.menu); let X=Q.find(D.item); let $=!1; let Y=!1; let Z=!1; let K=this; let J=M.data(I); S={initialize: function() {
        ...
        let n; let o; let a; return !!(t=t||S.get.userValues())&&(t=e.isArray(t)?t:[t], e.each(t, function(t, r) {
        ...
        const n=S.get.userValues(); n&&(S.debug('Adding user labels', n), e.each(n, function(e, t) {
        ...
        const t=(e=e.eq(0)).nextAll(D.item).not(D.unselectable).eq(0); const n=e.prevAll(D.item).not(D.unselectable).eq(0); t.length>0?(S.verbose('Moving selection to', t), t.addClass(T.selected)):(S.verbose('Moving selection to', n), n.addClass(T.selected));
      }}, setup: {api: function() {
        const e={debug: k.debug, urlData: {value: S.get.value(), query: S.get.query()}, on: !1}; S.verbose('First request, initializing API'), M.api(e);
      }, layout: function() {
        ...
        const t=S.get.selectValues(); S.debug('Dropdown initialized on a select', t), M.is('select')&&(U=M), U.parent(D.dropdown).length>0?(S.debug('UI dropdown already exists. Creating dropdown menu only'), M=U.closest(D.dropdown), S.has.menu()||S.create.menu(), Q=M.children(D.menu), S.setup.menu(t)):(S.debug('Creating entire dropdown from select'), M=e('<div />').attr('class', U.attr('class')).addClass(T.selection).addClass(T.dropdown).html(j.dropdown(t)).insertBefore(U), U.hasClass(T.multiple)&&!1===U.prop('multiple')&&(S.error(q.missingMultiple), U.prop('multiple', !0)), U.is('[multiple]')&&S.set.multiple(), U.prop('disabled')&&(S.debug('Disabling dropdown'), M.addClass(T.disabled)), U.removeAttr('class').detach().prependTo(M)), S.refresh();
      }, menu: function(e) {
        ...
        const e=r.slice(0, p); const t=r.slice(p+1); r=e.add(M).add(t);
      }}, refresh: function() {
        ...
        const e=Q.children(D.item).find(D.menu); S.verbose('Hiding sub menus', e), e.transition('hide');
      }, bind: {events: function() {
        ...
        const t=e!==i?e:S.get.query(); const n=function() {
        ...
        let i={errorDuration: !1, cache: 'local', throttle: k.throttle, urlData: {query: t}, onError: function() {
          S.add.message(A.serverError), n();
        }, onFailure: function() {
          S.add.message(A.serverError), n();
        }, onSuccess: function(t) {
          const i=t[R.remoteValues]; e.isArray(i)&&i.length>0?(S.remove.message(), S.setup.menu({values: t[R.remoteValues]})):S.add.message(A.noResults), n();
        }}; M.api('get request')||S.setup.api(), i=e.extend(!0, {}, i, k.apiSettings), M.api('setting', i).api('query');
      }, filterItems: function(t) {
        const n=t!==i?t:S.get.query(); let o=null; const a=S.escape.string(n); const r=new RegExp('^'+a, 'igm'); S.has.query()&&(o=[], S.verbose('Searching for matching values', n), X.each(function() {
          let t; let i; const a=e(this); if ('both'==k.match||'text'==k.match) {
        ...
        const n=t.length; const i=e.length; if (e=e.toLowerCase(), t=t.toLowerCase(), i>n) return !1; if (i===n) return e===t; e:for (let o=0, a=0; o<i; o++) {
          for (let r=e.charCodeAt(o); a<n;) if (t.charCodeAt(a++)===r) continue e; return !1;
        } return !0;
        ...
        const e=X.not(T.filtered).filter('.'+T.selected).eq(0); const t=X.not(T.filtered).filter('.'+T.active).eq(0); const n=e.length>0?e:t; if (n.length>0&&!S.is.multiple()) return S.debug('Forcing partial selection to selected item', n), void S.event.item.click.call(n, {}, !0); k.allowAdditions?(S.set.selected(S.get.query()), S.remove.searchTerm()):S.remove.searchTerm();
...
S.is.searchSelection()?b=!1:$=!1;
        ...
        const n=e(this); const i=M.find(D.label); const o=i.filter('.'+T.active); const a=n.nextAll('.'+T.active); const r=n.prevAll('.'+T.active); const s=a.length>0?n.nextUntil(a).add(o).add(n):n.prevUntil(r).add(o).add(n); t.shiftKey?(o.removeClass(T.active), s.addClass(T.active)):t.ctrlKey?n.toggleClass(T.active):(o.removeClass(T.active), n.addClass(T.active)), k.onLabelSelect.apply(this, i.filter('.'+T.active));
      }}, remove: {click: function() {
        const t=e(this).parent(); t.hasClass(T.active)?S.remove.activeLabels():S.remove.activeLabels(t);
      }}, test: {toggle: function(e) {
        const t=S.is.multiple()?S.show:S.toggle; S.is.bubbledLabelClick(e)||S.is.bubbledIconClick(e)||S.determine.eventOnElement(e, t)&&e.preventDefault();
      }, touch: function(e) {
...
'touchstart'==e.type?S.timer=setTimeout(function() {
  S.hide();
        ...
        S.debug('<select> modified, recreating menu'); let n=!1; e.each(t, function(t, i) {
        ...
        const n=t[0]; const i=n.addedNodes?e(n.addedNodes[0]):e(!1); const o=n.removedNodes?e(n.removedNodes[0]):e(!1); const a=i.add(o); const r=a.is(D.addition)||a.closest(D.addition).length>0; const s=a.is(D.message)||a.closest(D.message).length>0; r||s?(S.debug('Updating item selector cache'), S.refreshItems()):(S.debug('Menu modified, updating selector cache'), S.refresh());
      }, mousedown: function() {
        Y=!0;
      }, mouseup: function() {
        Y=!1;
      }}, item: {mouseenter: function(t) {
        const n=e(t.target); const i=e(this); const o=i.children(D.menu); const a=i.siblings(D.item).children(D.menu); const r=o.length>0; !(o.find(n).length>0)&&r&&(clearTimeout(S.itemTimer), S.itemTimer=setTimeout(function() {
          S.verbose('Showing sub-menu', o), e.each(a, function() {
            S.animate.hide(!1, e(this));
          }), S.animate.show(!1, o);
        }, k.delay.show), t.preventDefault());
      }, mouseleave: function(t) {
        const n=e(this).children(D.menu); n.length>0&&(clearTimeout(S.itemTimer), S.itemTimer=setTimeout(function() {
          S.verbose('Hiding sub-menu', n), S.animate.hide(!1, n);
        }, k.delay.hide));
      }, click: function(t, i) {
        const o=e(this); const a=e(t?t.target:''); const r=o.find(D.menu); const s=S.get.choiceText(o); const l=S.get.choiceValue(o, s); const c=r.length>0; const u=r.find(a).length>0; S.has.menuSearch()&&e(n.activeElement).blur(), u||c&&!k.allowCategorySelection||(S.is.searchSelection()&&(k.allowAdditions&&S.remove.userAddition(), S.remove.searchTerm(), S.is.focusedOnSearch()||1==i||S.focusSearch(!0)), k.useLabels||(S.remove.filteredItem(), S.set.scrollPosition(o)), S.determine.selectAction.call(this, s, l));
      }}, document: {keydown: function(e) {
        const t=e.which; if (S.is.inObject(t, P)) {
          const n=M.find(D.label); let i=n.filter('.'+T.active); const o=(i.data(E.value), n.index(i)); const a=n.length; const r=i.length>0; const s=i.length>1; const l=0===o; const c=o+1==a; const u=S.is.searchSelection(); const d=S.is.focusedOnSearch(); const f=S.is.focused(); const m=d&&0===S.get.caretPosition(); if (u&&!r&&!d) return; t==P.leftArrow?!f&&!m||r?r&&(e.shiftKey?S.verbose('Adding previous label to selection'):(S.verbose('Selecting previous label'), n.removeClass(T.active)), l&&!s?i.addClass(T.active):i.prev(D.siblingLabel).addClass(T.active).end(), e.preventDefault()):(S.verbose('Selecting previous label'), n.last().addClass(T.active)):t==P.rightArrow?(f&&!r&&n.first().addClass(T.active), r&&(e.shiftKey?S.verbose('Adding next label to selection'):(S.verbose('Selecting next label'), n.removeClass(T.active)), c?u?d?n.removeClass(T.active):S.focusSearch():s?i.next(D.siblingLabel).addClass(T.active):i.addClass(T.active):i.next(D.siblingLabel).addClass(T.active), e.preventDefault())):t==P.deleteKey||t==P.backspace?r?(S.verbose('Removing active labels'), c&&u&&!d&&S.focusSearch(), i.last().next(D.siblingLabel).addClass(T.active), S.remove.activeLabels(i), e.preventDefault()):m&&!r&&t==P.backspace&&(S.verbose('Removing last label on input backspace'), i=n.last().addClass(T.active), S.remove.activeLabels(i)):i.removeClass(T.active);
        }
      }}, keydown: function(e) {
        let t=e.which; if (S.is.inObject(t, P)) {
          let n; const i=X.not(D.unselectable).filter('.'+T.selected).eq(0); const o=Q.children('.'+T.active).eq(0); const a=i.length>0?i:o; const r=a.length>0?a.siblings(':not(.'+T.filtered+')').addBack():Q.children(':not(.'+T.filtered+')'); const s=a.children(D.menu); const l=a.closest(D.menu); const c=l.hasClass(T.visible)||l.hasClass(T.animating)||l.parent(D.menu).length>0; const u=s.length>0; const d=a.length>0; const f=a.not(D.unselectable).length>0; const m=t==P.delimiter&&k.allowAdditions&&S.is.multiple(); if (k.allowAdditions&&k.hideAdditions&&(t==P.enter||m)&&f&&(S.verbose('Selecting item from keyboard shortcut', a), S.event.item.click.call(a, e), S.is.searchSelection()&&S.remove.searchTerm()), S.is.visible()) {
        ...
        const e=n.createEvent('HTMLEvents'); const t=U[0]; t&&(S.verbose('Triggering native change event'), e.initEvent('change', !0, !1), t.dispatchEvent(e));
        ...
        const o=e(t.target); const a=o.closest(n.documentElement).length>0; const r=o.closest(M).length>0; return i=e.isFunction(i)?i:function() {}, a&&!r?(S.verbose('Triggering event', i), i(), !0):(S.verbose('Event occurred in dropdown, canceling callback'), !1);
      }, eventOnElement: function(t, i) {
        const o=e(t.target); const a=o.closest(D.siblingLabel); const r=n.body.contains(t.target); const s=0===M.find(a).length; const l=0===o.closest(Q).length; return i=e.isFunction(i)?i:function() {}, r&&s&&l?(S.verbose('Triggering event', i), i(), !0):(S.verbose('Event occurred in dropdown menu, canceling callback'), !1);
        ...
        const t=S.get.values(); return S.is.multiple()?e.isArray(t)?t.length:0:''!==S.get.value()?1:0;
      }, transition: function(e) {
        return 'auto'==k.transition?S.is.upward(e)?'slide up':'slide down':k.transition;
      }, userValues: function() {
        let t=S.get.values(); return !!t&&(t=e.isArray(t)?t:[t], e.grep(t, function(e) {
        ...
        let e; let t; const i=N.get(0); return 'selectionStart'in i?i.selectionStart:n.selection?(i.focus(), t=(e=n.selection.createRange()).text.length, e.moveStart('character', -i.value.length), e.text.length-t):void 0;
      }, value: function() {
        const t=U.length>0?U.val():M.data(E.value); const n=e.isArray(t)&&1===t.length&&''===t[0]; return t===i||n?'':t;
      }, values: function() {
        const e=S.get.value(); return ''===e?'':!S.has.selectInput()&&S.is.multiple()?'string'==typeof e?e.split(k.delimiter):'':e;
      }, remoteValues: function() {
        let t=S.get.values(); let n=!1; return t&&('string'==typeof t&&(t=[t]), e.each(t, function(e, t) {
          const i=S.read.remoteData(t); S.verbose('Restoring value from session data', i, t), i&&(n||(n={}), n[t]=i);
        })), n;
        ...
        const e=N[0]; return !!e&&(e.oninput!==i?'input':e.onpropertychange!==i?'propertychange':'keyup');
      }, selectValues: function() {
        const t={values: []}; return M.find('option').each(function() {
          const n=e(this); const o=n.html(); const a=n.attr('disabled'); const r=n.attr('value')!==i?n.attr('value'):o; 'auto'===k.placeholder&&''===r?t.placeholder=o:t.values.push({name: o, value: r, disabled: a});
        ...
        const e=X.not(D.unselectable).filter('.'+T.selected); return e.length>0?e:X.eq(0);
      }, itemWithAdditions: function(e) {
        let t=S.get.item(e); const n=S.create.userChoice(e); return n&&n.length>0&&(t=t.length>0?t.add(n):n), t;
      }, item: function(t, n) {
        let o; let a; let r=!1; return t=t!==i?t:S.get.values()!==i?S.get.values():S.get.text(), o=a?t.length>0:t!==i&&null!==t, a=S.is.multiple()&&e.isArray(t), n=''===t||0===t||(n||!1), o&&X.each(function() {
          const o=e(this); const s=S.get.choiceText(o); const l=S.get.choiceValue(o, s); if (null!==l&&l!==i) {
            if (a)-1===e.inArray(String(l), t)&&-1===e.inArray(s, t)||(r=r?r.add(o):o); else if (n) {
        ...
        const e=S.get.defaultText(); e===S.get.placeholderText?(S.debug('Restoring default placeholder text', e), S.set.placeholderText(e)):(S.debug('Restoring default text', e), S.set.text(e));
      }, placeholderText: function() {
        S.set.placeholderText();
      }, defaultValue: function() {
        const e=S.get.defaultValue(); e!==i&&(S.debug('Restoring default value', e), ''!==e?(S.set.value(e), S.set.selected()):(S.remove.activeItem(), S.remove.selectedItem()));
      }, labels: function() {
        ...
        const t=S.get.remoteValues(); S.debug('Recreating selected from session data', t), t&&(S.is.single()?e.each(t, function(e, t) {
          S.set.text(t);
        }):e.each(t, function(e, t) {
          S.add.label(e, t);
        }));
      }}, read: {remoteData: function(e) {
        let n; if (t.Storage!==i) return (n=sessionStorage.getItem(e))!==i&&n; S.error(q.noStorage);
      }}, save: {defaults: function() {
        S.save.defaultText(), S.save.placeholderText(), S.save.defaultValue();
      }, defaultValue: function() {
        const e=S.get.value(); S.verbose('Saving default value as', e), M.data(E.defaultValue, e);
      }, defaultText: function() {
        const e=S.get.text(); S.verbose('Saving default text as', e), M.data(E.defaultText, e);
      }, placeholderText: function() {
        let e; !1!==k.placeholder&&V.hasClass(T.placeholder)&&(e=S.get.text(), S.verbose('Saving placeholder text as', e), M.data(E.placeholderText, e));
...
S.is.multiple()&&k.useLabels?S.remove.labels():(S.remove.activeItem(), S.remove.selectedItem()), S.set.placeholderText(), S.clearValue();
        ...
        let n; let i; const o=t||S.get.selectedItem(); const a=o.closest(D.menu); const r=a.outerHeight(); const s=a.scrollTop(); const l=X.eq(0).outerHeight(); const c=Math.floor(r/l); const u=(a.prop('scrollHeight'), 'up'==e?s-l*c:s+l*c); const d=X.not(D.unselectable); i='up'==e?d.index(o)-c:d.index(o)+c, (n=('up'==e?i>=0:i<d.length)?d.eq(i):'up'==e?d.first():d.last()).length>0&&(S.debug('Scrolling page', e, n), o.removeClass(T.selected), n.addClass(T.selected), k.selectOnKeydown&&S.is.single()&&S.set.selectedItem(n), a.scrollTop(u));
      }, set: {filtered: function() {
        const e=S.is.multiple(); const t=S.is.searchSelection(); const n=e&&t; const i=t?S.get.query():''; const o='string'==typeof i&&i.length>0; const a=S.get.searchWidth(); const r=''!==i; e&&o&&(S.verbose('Adjusting input width', a, k.glyphWidth), N.css('width', a)), o||n&&r?(S.verbose('Hiding placeholder text'), V.addClass(T.filtered)):(!e||n&&!r)&&(S.verbose('Showing placeholder text'), V.removeClass(T.filtered));
      }, empty: function() {
        M.addClass(T.empty);
      }, loading: function() {
...
k.allowAdditions&&e.filter(D.addition).length>0?e.addClass(T.filtered):e.addClass(T.active);
        ...
        const t=S.get.query().length; N.val(e.substr(0, t));
      }, scrollPosition: function(e, t) {
        let n; let o; let a; let r; let s; let l; n=(e=e||S.get.selectedItem()).closest(D.menu), o=e&&e.length>0, t=t!==i&&t, e&&n.length>0&&o&&(e.position().top, n.addClass(T.loading), a=(r=n.scrollTop())-n.offset().top+e.offset().top, t||(l=r+n.height()<a+5, s=a-5<r), S.debug('Scrolling to active item', a), (t||s||l)&&n.scrollTop(a), n.removeClass(T.loading));
      }, text: function(e) {
        ...
        const t=S.get.choiceValue(e); const n=S.get.choiceText(e, !1); const i=S.get.choiceText(e, !0); S.debug('Setting user selection to item', e), S.remove.activeItem(), S.set.partialSearch(n), S.set.activeItem(e), S.set.selected(t, e), S.set.text(i);
      }, selectedLetter: function(t) {
        let n; const i=X.filter('.'+T.selected); let o=!1; i.length>0&&S.has.firstLetter(i, t)&&(n=i.nextAll(X).eq(0), S.has.firstLetter(n, t)&&(o=n)), o||X.each(function() {
...
'auto'==k.direction?(S.remove.upward(), S.can.openDownward(e)?S.remove.upward(e):S.set.upward(e), S.is.leftward(e)||S.can.openRightward(e)||S.set.leftward(e)):'upward'==k.direction&&S.set.upward(e);
        ...
        const o=S.escape.value(e); const a=U.length>0; const r=S.get.values(); const s=e!==i?String(e):e; if (a) {
        ...
        const t=S.escape.value(e); const n=U.find('option[value="'+S.escape.string(t)+'"]'); n.length>0&&n.hasClass(T.addition)&&(C&&(C.disconnect(), S.verbose('Temporarily disconnecting mutation observer')), n.remove(), S.verbose('Removing user addition as an <option>', t), C&&C.observe(U[0], {childList: !0, subtree: !0}));
      }, message: function() {
        ...
        t=t||M.find(D.label), S.verbose('Removing labels', t), t.each(function() {
          const t=e(this); const n=t.data(E.value); const o=n!==i?String(n):n; const a=S.is.userValue(o); !1!==k.onLabelRemove.call(t, n)?(S.remove.message(), a?(S.remove.value(o), S.remove.label(o)):S.remove.selected(o)):S.debug('Label remove callback cancelled removal');
        });
      }, tabbable: function() {
S.is.searchSelection()?(S.debug('Searchable dropdown initialized'), N.removeAttr('tabindex'), Q.removeAttr('tabindex')):(S.debug('Simple selection dropdown initialized'), M.removeAttr('tabindex'), Q.removeAttr('tabindex'));
        ...
        let n; return !(!e||0===e.length||'string'!=typeof t)&&(n=S.get.choiceText(e, !1), (t=t.toLowerCase())==String(n).charAt(0).toLowerCase());
      }, input: function() {
        return U.length>0;
      }, items: function() {
        return X.length>0;
        ...
        let t=S.escape.value(e); const n=M.find(D.label); return k.ignoreCase&&(t=t.toLowerCase()), n.filter('[data-'+E.value+'="'+S.escape.string(t)+'"]').length>0;
      }, maxSelections: function() {
        return k.maxSelections&&S.get.selectionCount()>=k.maxSelections;
      }, allResultsFiltered: function() {
        const e=X.not(D.addition); return e.filter(D.unselectable).length===e.length;
        ...
        const n=S.get.values(); return !!(e.isArray(n)?n&&-1!==e.inArray(t, n):n==t);
      }, valueIgnoringCase: function(t) {
        let n=S.get.values(); let i=!1; return e.isArray(n)||(n=[n]), e.each(n, function(e, n) {
        ...
        let i=!1; return e.each(n, function(e, n) {
          if (n==t) return i=!0, !0;
        }), i;
      }, multiple: function() {
        ...
        let n=!1; return e.each(t, function(t, i) {
        ...
        let o; const a=n||Q; const r=n?function() {}:function() {
        ...
        const n=e.isArray(t); const i='string'==typeof t; const o=!i&&!n; const a=i&&-1!==t.search(O.quote); const r=[]; return o||!a?t:(S.debug('Encoding quote values for use in select', t), n?(e.each(t, function(e, t) {
        ...
        let t; let n; k.performance&&(n=(t=(new Date).getTime())-(u||t), u=t, d.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': K, 'Execution Time': n})), clearTimeout(S.performance.timer), S.performance.timer=setTimeout(S.performance.display, 500);
      }, display: function() {
        let t=k.name+':'; let n=0; u=!1, clearTimeout(S.performance.timer), e.each(d, function(e, t) {
          n+=t['Execution Time'];
        ...
        let r; let s; let l; let c=J; return n=n||g, o=K||o, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
    ...
    const n=t.placeholder||!1; let i=(t.values, ''); return i+='<i class="dropdown icon"></i>', t.placeholder?i+='<div class="default text">'+n+'</div>':i+='<div class="text"></div>', i+='<div class="menu">', e.each(t.values, function(e, t) {
      i+=t.disabled?'<div class="disabled item" data-value="'+t.value+'">'+t.name+'</div>':'<div class="item" data-value="'+t.value+'">'+t.name+'</div>';
    }), i+='</div>';
  }, menu: function(t, n) {
    const i=t[n.values]||{}; let o=''; return e.each(i, function(e, t) {
      const i=t[n.text]?'data-text="'+t[n.text]+'"':''; const a=t[n.disabled]?'disabled ':''; o+='<div class="'+a+'item" data-value="'+t[n.value]+'"'+i+'>', o+=t[n.name], o+='</div>';
    }), o;
  }, label: function(e, t) {
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.embed=function(n) {
    let o; const a=e(this); const r=a.selector||''; let s=(new Date).getTime(); let l=[]; const c=arguments[0]; const u='string'==typeof c; const d=[].slice.call(arguments, 1); return a.each(function() {
      let f; const m=e.isPlainObject(n)?e.extend(!0, {}, e.fn.embed.settings, n):e.extend({}, e.fn.embed.settings); const g=m.selector; const p=m.className; const h=m.sources; const v=m.error; const b=m.metadata; const y=m.namespace; const x=m.templates; const C='.'+y; const w='module-'+y; const S=(e(t), e(this)); let k=(S.find(g.placeholder), S.find(g.icon), S.find(g.embed)); const T=this; let A=S.data(w); f={initialize: function() {
...
f.get.placeholder()?f.createPlaceholder():f.createAndShow();
        ...
        const t=f.get.icon(); const n=f.get.url(); f.generate.embed(n); e=e||f.get.placeholder(), S.html(x.placeholder(e, t)), f.debug('Creating placeholder for embed', e, t);
        ...
        const e=f.get.source(); return h[e]!==i&&h[e].type;
      }, url: function() {
        return m.url?m.url:S.data(b.url)!==i?S.data(b.url):f.determine.url();
      }}, determine: {autoplay: function() {
        f.should.autoplay()&&(m.autoplay=!0);
      }, source: function(t) {
        let n=!1; return (t=t||f.get.url())&&e.each(h, function(e, i) {
          if (-1!==t.search(i.domain)) return n=e, !1;
        }), n;
      }, icon: function() {
        const e=f.get.source(); return h[e]!==i&&h[e].icon;
      }, url: function() {
        let e; const t=m.id||S.data(b.id); const n=m.source||S.data(b.source); return (e=h[n]!==i&&h[n].url.replace('{id}', t))&&S.data(b.url, e), e;
      }}, set: {active: function() {
        S.addClass(p.active);
      }}, remove: {active: function() {
        ...
        let t; const n=[]; for (t in e)n.push(encodeURIComponent(t)+'='+encodeURIComponent(e[t])); return n.join('&amp;');
      }}, generate: {embed: function(e) {
        f.debug('Generating embed html'); let t; let n; const i=f.get.source(); return (e=f.get.url(e))?(n=f.generate.parameters(i), t=x.iframe(e, n)):f.error(v.noURL, S), t;
      }, parameters: function(t, n) {
        let o=h[t]&&h[t].parameters!==i?h[t].parameters(m):{}; return (n=n||m.parameters)&&(o=e.extend({}, o, n)), o=m.onEmbed(o), f.encode.parameters(o);
      }}, has: {embed: function() {
        return k.length>0;
      }, placeholder: function() {
        return m.placeholder||S.data(b.placeholder);
        ...
        let t; let n; m.performance&&(n=(t=(new Date).getTime())-(s||t), s=t, l.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': T, 'Execution Time': n})), clearTimeout(f.performance.timer), f.performance.timer=setTimeout(f.performance.display, 500);
      }, display: function() {
        let t=m.name+':'; let n=0; s=!1, clearTimeout(f.performance.timer), e.each(l, function(e, t) {
          n+=t['Execution Time'];
        }), t+=' '+n+'ms', r&&(t+=' \''+r+'\''), a.length>1&&(t+=' ('+a.length+')'), (console.group!==i||console.table!==i)&&l.length>0&&(console.groupCollapsed(t), console.table?console.table(l):e.each(l, function(e, t) {
          console.log(t.Name+': '+t['Execution Time']+'ms');
        }), console.groupEnd()), l=[];
      }}, invoke: function(t, n, a) {
        let r; let s; let l; let c=A; return n=n||d, a=T||a, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
            if (c[a]!==i) return s=c[a], !1; if (!e.isPlainObject(c[o])||n==r) return c[o]!==i?(s=c[o], !1):(f.error(v.method, t), !1); c=c[o];
          }
        })), e.isFunction(s)?l=s.apply(a, n):s!==i&&(l=s), e.isArray(o)?o.push(l):o!==i?o=[o, l]:l!==i&&(o=l), s;
    ...
    let n=e; return t&&(n+='?'+t), '<iframe src="'+n+'" width="100%" height="100%" frameborder="0" scrolling="no" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
  }, placeholder: function(e, t) {
    let n=''; return t&&(n+='<i class="'+t+' icon"></i>'), e&&(n+='<img class="placeholder" src="'+e+'">'), n;
  }}, api: !1, onPause: function() {}, onPlay: function() {}, onStop: function() {}};
}(jQuery, window, document), function(e, t, n, i) {
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.modal=function(o) {
    let a; const r=e(this); const s=e(t); const l=e(n); const c=e('body'); const u=r.selector||''; let d=(new Date).getTime(); let f=[]; const m=arguments[0]; const g='string'==typeof m; const p=[].slice.call(arguments, 1); const h=t.requestAnimationFrame||t.mozRequestAnimationFrame||t.webkitRequestAnimationFrame||t.msRequestAnimationFrame||function(e) {
      setTimeout(e, 0);
    }; return r.each(function() {
      let r; let v; let b; let y; let x; let C; let w; let S; let k; const T=e.isPlainObject(o)?e.extend(!0, {}, e.fn.modal.settings, o):e.extend({}, e.fn.modal.settings); const A=T.selector; const R=T.className; const P=T.namespace; const E=T.error; const F='.'+P; const O='module-'+P; const D=e(this); const q=e(T.context); const j=D.find(A.close); const z=this; let I=D.data(O); let M=!1; k={initialize: function() {
        ...
        const t={debug: T.debug, variation: !T.centered&&'top aligned', dimmerName: 'modals'}; const n=e.extend(!0, t, T.dimmerSettings); e.fn.dimmer!==i?(k.debug('Creating dimmer'), y=q.dimmer(n), T.detachable?(k.verbose('Modal is detachable, moving content into dimmer'), y.dimmer('add content', D)):k.set.undetached(), x=y.dimmer('get dimmer')):k.error(E.dimmer);
      }, id: function() {
        ...
        const i=e(t); n=e.isFunction(k[n])?k[n]:k.toggle, i.length>0?(k.debug('Attaching modal events to element', t, n), i.off(F).on('click'+F, n)):k.error(E.notFound, t);
      }, bind: {events: function() {
...
M||!1===T.onDeny.call(z, e(this))?k.verbose('Deny callback returned false cancelling hide'):(M=!0, k.hide(function() {
  M=!1;
        ...
        if (T.closable) {
          const i=e(t.target).closest(A.modal).length>0; const o=e.contains(n.documentElement, t.target); !i&&o&&k.is.active()&&(k.debug('Dimmer clicked, hiding all modals'), k.remove.clickaway(), T.allowMultiple?k.hide():k.hideAll());
...
y.dimmer('is animating')||y.dimmer('is active')?y.dimmer('hide', function() {
  k.remove.clickaway(), k.remove.screenHeight();
        ...
        const n=r.filter('.'+R.active+', .'+R.animating); t=e.isFunction(t)?t:function() {}, n.length>0&&(k.debug('Hiding all visible modals'), k.hideDimmer(), n.modal('hide modal', t));
      }, hideOthers: function(t) {
        const n=v.filter('.'+R.active+', .'+R.animating); t=e.isFunction(t)?t:function() {}, n.length>0&&(k.debug('Hiding other modals', v), n.modal('hide modal', t, !0));
        ...
        D.addClass(R.loading); const o=D.prop('scrollHeight'); const a=D.outerHeight(); k.cache!==i&&0===a||(k.cache={pageHeight: e(n).outerHeight(), height: a+T.offset, scrollHeight: o+T.offset, contextHeight: 'body'==T.context?e(t).height():y.height()}, k.cache.topOffset=-k.cache.height/2), D.removeClass(R.loading), k.debug('Caching modal and container sizes', k.cache);
      }, can: {fit: function() {
        const e=k.cache.contextHeight; const t=k.cache.contextHeight/2; const n=k.cache.topOffset; const i=k.cache.scrollHeight; const o=k.cache.height; const a=T.padding; return i>o?t+n+i+a<e:o+2*a<e;
      }}, is: {active: function() {
...
k.can.fit()?(k.verbose('Modal fits on screen'), k.others.active()||k.others.animating()||k.remove.scrolling()):(k.verbose('Modal cannot fit on screen setting to scrolling'), k.set.scrolling());
        ...
        let t; let n; T.performance&&(n=(t=(new Date).getTime())-(d||t), d=t, f.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': z, 'Execution Time': n})), clearTimeout(k.performance.timer), k.performance.timer=setTimeout(k.performance.display, 500);
      }, display: function() {
        let t=T.name+':'; let n=0; d=!1, clearTimeout(k.performance.timer), e.each(f, function(e, t) {
          n+=t['Execution Time'];
        ...
        let r; let s; let l; let c=I; return n=n||p, o=z||o, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
            if (c[a]!==i) return s=c[a], !1; if (!e.isPlainObject(c[o])||n==r) return c[o]!==i&&(s=c[o], !1); c=c[o];
          }
        })), e.isFunction(s)?l=s.apply(o, n):s!==i&&(l=s), e.isArray(a)?a.push(l):a!==i?a=[a, l]:l!==i&&(a=l), s;
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.nag=function(n) {
    let o; const a=e(this); const r=a.selector||''; let s=(new Date).getTime(); let l=[]; const c=arguments[0]; const u='string'==typeof c; const d=[].slice.call(arguments, 1); return a.each(function() {
      let a; const f=e.isPlainObject(n)?e.extend(!0, {}, e.fn.nag.settings, n):e.extend({}, e.fn.nag.settings); const m=(f.className, f.selector); const g=f.error; const p=f.namespace; const h='.'+p; const v=p+'-module'; const b=e(this); const y=(b.find(m.close), f.context?e(f.context):e('body')); const x=this; const C=b.data(v); t.requestAnimationFrame||t.mozRequestAnimationFrame||t.webkitRequestAnimationFrame||t.msRequestAnimationFrame; a={initialize: function() {
        ...
        const e={}; return f.expires&&(e.expires=f.expires), f.domain&&(e.domain=f.domain), f.path&&(e.path=f.path), e;
      }}, clear: function() {
        a.storage.remove(f.key);
      }, storage: {set: function(n, o) {
        const r=a.get.storageOptions(); if ('localstorage'==f.storageMethod&&t.localStorage!==i)t.localStorage.setItem(n, o), a.debug('Value stored using local storage', n, o); else if ('sessionstorage'==f.storageMethod&&t.sessionStorage!==i)t.sessionStorage.setItem(n, o), a.debug('Value stored using session storage', n, o); else {
          if (e.cookie===i) return void a.error(g.noCookieStorage); e.cookie(n, o, r), a.debug('Value stored using cookie', n, o, r);
        }
      }, get: function(n, o) {
        let r; return 'localstorage'==f.storageMethod&&t.localStorage!==i?r=t.localStorage.getItem(n):'sessionstorage'==f.storageMethod&&t.sessionStorage!==i?r=t.sessionStorage.getItem(n):e.cookie!==i?r=e.cookie(n):a.error(g.noCookieStorage), 'undefined'!=r&&'null'!=r&&r!==i&&null!==r||(r=i), r;
      }, remove: function(n) {
        const o=a.get.storageOptions(); 'localstorage'==f.storageMethod&&t.localStorage!==i?t.localStorage.removeItem(n):'sessionstorage'==f.storageMethod&&t.sessionStorage!==i?t.sessionStorage.removeItem(n):e.cookie!==i?e.removeCookie(n, o):a.error(g.noStorage);
      }}, setting: function(t, n) {
        ...
        let t; let n; f.performance&&(n=(t=(new Date).getTime())-(s||t), s=t, l.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': x, 'Execution Time': n})), clearTimeout(a.performance.timer), a.performance.timer=setTimeout(a.performance.display, 500);
      }, display: function() {
        let t=f.name+':'; let n=0; s=!1, clearTimeout(a.performance.timer), e.each(l, function(e, t) {
          n+=t['Execution Time'];
        ...
        let s; let l; let c; let u=C; return n=n||d, r=x||r, 'string'==typeof t&&u!==i&&(t=t.split(/[\. ]/), s=t.length-1, e.each(t, function(n, o) {
          const r=n!=s?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(u[r])&&n!=s)u=u[r]; else {
            if (u[r]!==i) return l=u[r], !1; if (!e.isPlainObject(u[o])||n==s) return u[o]!==i?(l=u[o], !1):(a.error(g.method, t), !1); u=u[o];
          }
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.popup=function(o) {
    let a; const r=e(this); const s=e(n); const l=e(t); const c=e('body'); const u=r.selector||''; let d=(new Date).getTime(); let f=[]; const m=arguments[0]; const g='string'==typeof m; const p=[].slice.call(arguments, 1); return r.each(function() {
      let r; let h; let v; let b; let y; let x; const C=e.isPlainObject(o)?e.extend(!0, {}, e.fn.popup.settings, o):e.extend({}, e.fn.popup.settings); const w=C.selector; const S=C.className; const k=C.error; const T=C.metadata; const A=C.namespace; const R='.'+C.namespace; const P='module-'+A; const E=e(this); const F=e(C.context); const O=e(C.scrollContext); const D=e(C.boundary); const q=C.target?e(C.target):E; let j=0; let z=!1; let I=!1; const M=this; let L=E.data(P); x={initialize: function() {
...
C.popup?r=e(C.popup).eq(0):C.inline&&(r=q.nextAll(w.popup).eq(0), C.popup=r), C.popup?(r.addClass(S.loading), h=x.get.offsetParent(), r.removeClass(S.loading), C.movePopup&&x.has.popup()&&x.get.offsetParent(r)[0]!==h[0]&&(x.debug('Moving popup to the same offset parent as target'), r.detach().appendTo(h))):h=C.inline?x.get.offsetParent(q):x.has.popup()?x.get.offsetParent(r):c, h.is('html')&&h[0]!==c[0]&&(x.debug('Setting page as offset parent'), h=c), x.get.variation()&&x.set.variation();
        ...
        const n=e.isPlainObject(C.delay)?C.delay.show:C.delay; clearTimeout(x.hideTimer), I||(x.showTimer=setTimeout(x.show, n));
      }, end: function() {
        const t=e.isPlainObject(C.delay)?C.delay.hide:C.delay; clearTimeout(x.showTimer), x.hideTimer=setTimeout(x.hide, t);
        ...
        let e; const n=x.get.offsetParent(r); const i=q[0]; const o=D[0]==t; const a=C.inline||C.popup&&C.movePopup?q.position():q.offset(); const s=o?{top: 0, left: 0}:D.offset(); let c={}; const u=o?{top: l.scrollTop(), left: l.scrollLeft()}:{top: 0, left: 0}; if (c={target: {element: q[0], width: q.outerWidth(), height: q.outerHeight(), top: a.top, left: a.left, margin: {}}, popup: {width: r.outerWidth(), height: r.outerHeight()}, parent: {width: h.outerWidth(), height: h.outerHeight()}, screen: {top: s.top, left: s.left, scroll: {top: u.top, left: u.left}, width: D.width(), height: D.height()}}, n.get(0)!==h.get(0)) {
          const d=n.offset(); c.target.top-=d.top, c.target.left-=d.left, c.parent.width=n.outerWidth(), c.parent.height=n.outerHeight();
        ...
        const i=[]; return e.each(t, function(e, t) {
        ...
        let t; let n; C.performance&&(n=(t=(new Date).getTime())-(d||t), d=t, f.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': M, 'Execution Time': n})), clearTimeout(x.performance.timer), x.performance.timer=setTimeout(x.performance.display, 500);
      }, display: function() {
        let t=C.name+':'; let n=0; d=!1, clearTimeout(x.performance.timer), e.each(f, function(e, t) {
          n+=t['Execution Time'];
        }), t+=' '+n+'ms', u&&(t+=' \''+u+'\''), (console.group!==i||console.table!==i)&&f.length>0&&(console.groupCollapsed(t), console.table?console.table(f):e.each(f, function(e, t) {
          console.log(t.Name+': '+t['Execution Time']+'ms');
        }), console.groupEnd()), f=[];
      }}, invoke: function(t, n, o) {
        let r; let s; let l; let c=L; return n=n||p, o=M||o, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
            if (c[a]!==i) return s=c[a], !1; if (!e.isPlainObject(c[o])||n==r) return c[o]!==i&&(s=c[o], !1); c=c[o];
          }
        })), e.isFunction(s)?l=s.apply(o, n):s!==i&&(l=s), e.isArray(a)?a.push(l):a!==i?a=[a, l]:l!==i&&(a=l), s;
    ...
    const t={'&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', '\'': '&#x27;', '`': '&#x60;'}; return /[&<>"'`]/.test(e)?e.replace(/[&<>"'`]/g, function(e) {
      return t[e];
    }):e;
  }, popup: function(t) {
    let n=''; const o=e.fn.popup.settings.templates.escape; return typeof t!==i&&(typeof t.title!==i&&t.title&&(t.title=o(t.title), n+='<div class="header">'+t.title+'</div>'), typeof t.content!==i&&t.content&&(t.content=o(t.content), n+='<div class="content">'+t.content+'</div>')), n;
  }}};
}(jQuery, window, document), function(e, t, n, i) {
  'use strict'; void 0!==(t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')())&&t.Math==Math||('undefined'!=typeof self&&self.Math==Math?self:Function('return this')()); e.fn.progress=function(t) {
    let o; const a=e(this); const r=a.selector||''; let s=(new Date).getTime(); let l=[]; const c=arguments[0]; const u='string'==typeof c; const d=[].slice.call(arguments, 1); return a.each(function() {
      let a; const f=e.isPlainObject(t)?e.extend(!0, {}, e.fn.progress.settings, t):e.extend({}, e.fn.progress.settings); const m=f.className; const g=f.metadata; const p=f.namespace; const h=f.selector; const v=f.error; const b='.'+p; const y='module-'+p; const x=e(this); const C=e(this).find(h.bar); const w=e(this).find(h.progress); const S=e(this).find(h.label); const k=this; let T=x.data(y); let A=!1; a={initialize: function() {
        ...
        const e={percent: x.data(g.percent), total: x.data(g.total), value: x.data(g.value)}; e.percent&&(a.debug('Current percent value set from metadata', e.percent), a.set.percent(e.percent)), e.total&&(a.debug('Total value set from metadata', e.total), a.set.total(e.total)), e.value&&(a.debug('Current value set from metadata', e.value), a.set.value(e.value), a.set.progress(e.value));
      }, settings: function() {
        ...
        const t=a.get.transitionEnd(); C.one(t+b, function(t) {
        ...
        let t; let n; a.has.total()?n=(t=a.get.value())+(e=e||1):(n=(t=a.get.percent())+(e=e||a.get.randomValue()), 100, a.debug('Incrementing percentage by', t, n)), n=a.get.normalizedValue(n), a.set.progress(n);
      }, decrement: function(e) {
        let t; let n; a.get.total()?(n=(t=a.get.value())-(e=e||1), a.debug('Decrementing value by', e, t)):(n=(t=a.get.percent())-(e=e||a.get.randomValue()), a.debug('Decrementing percentage by', e, t)), n=a.get.normalizedValue(n), a.set.progress(n);
      }, has: {progressPoll: function() {
        return a.progressPoll;
      }, total: function() {
        return !1!==a.get.total();
      }}, get: {text: function(e) {
        const t=a.value||0; const n=a.total||0; const i=A?a.get.displayPercent():a.percent||0; const o=a.total>0?n-t:100-i; return e=(e=e||'').replace('{value}', t).replace('{total}', n).replace('{left}', o).replace('{percent}', i), a.verbose('Adding variables to progress bar text', e), e;
        ...
        let e; const t=n.createElement('element'); const o={transition: 'transitionend', OTransition: 'oTransitionEnd', MozTransition: 'transitionend', WebkitTransition: 'webkitTransitionEnd'}; for (e in o) if (t.style[e]!==i) return o[e];
      }, displayPercent: function() {
        const e=C.width(); const t=x.width(); const n=e>parseInt(C.css('min-width'), 10)?e/t*100:a.percent; return f.precision>0?Math.round(n*(10*f.precision))/(10*f.precision):Math.round(n);
      }, percent: function() {
        return a.percent||0;
      }, value: function() {
...
a.has.progressPoll()?(a.debug('Updated within interval, setting next update to use new value', e), a.set.nextValue(e)):(a.debug('First update in progress update interval, immediately updating', e), a.update.progress(e), a.create.progressPoll());
        ...
        const e=a.nextValue; e&&(a.debug('Update interval complete using last updated value', e), a.update.progress(e), a.remove.nextValue());
      }, progress: function(e) {
        let t; !1===(e=a.get.numericValue(e))&&a.error(v.nonNumeric, e), e=a.get.normalizedValue(e), a.has.total()?(a.set.value(e), t=e/a.total*100, a.debug('Calculating percent complete from total', t), a.set.percent(t)):(t=e, a.debug('Setting value to exact percentage value', t), a.set.percent(t));
      }}, setting: function(t, n) {
        if (a.debug('Changing setting', t, n), e.isPlainObject(t))e.extend(!0, f, t); else {
          if (n===i) return f[t]; e.isPlainObject(f[t])?e.extend(!0, f[t], n):f[t]=n;
        }
        ...
        let t; let n; f.performance&&(n=(t=(new Date).getTime())-(s||t), s=t, l.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': k, 'Execution Time': n})), clearTimeout(a.performance.timer), a.performance.timer=setTimeout(a.performance.display, 500);
      }, display: function() {
        let t=f.name+':'; let n=0; s=!1, clearTimeout(a.performance.timer), e.each(l, function(e, t) {
          n+=t['Execution Time'];
        }), t+=' '+n+'ms', r&&(t+=' \''+r+'\''), (console.group!==i||console.table!==i)&&l.length>0&&(console.groupCollapsed(t), console.table?console.table(l):e.each(l, function(e, t) {
        ...
        let s; let l; let c; let u=T; return n=n||d, r=k||r, 'string'==typeof t&&u!==i&&(t=t.split(/[\. ]/), s=t.length-1, e.each(t, function(n, o) {
          const r=n!=s?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(u[r])&&n!=s)u=u[r]; else {
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.rating=function(t) {
    let n; const o=e(this); const a=o.selector||''; let r=(new Date).getTime(); let s=[]; const l=arguments[0]; const c='string'==typeof l; const u=[].slice.call(arguments, 1); return o.each(function() {
      let d; let f; const m=e.isPlainObject(t)?e.extend(!0, {}, e.fn.rating.settings, t):e.extend({}, e.fn.rating.settings); const g=m.namespace; const p=m.className; const h=m.metadata; const v=m.selector; const b=(m.error, '.'+g); const y='module-'+g; const x=this; let C=e(this).data(y); const w=e(this); let S=w.find(v.icon); f={initialize: function() {
        ...
        const t=f.get.maxRating(); const n=e.fn.rating.settings.templates.icon(t); f.debug('Generating icon html dynamically'), w.html(n), f.refresh();
      }}, event: {mouseenter: function() {
        const t=e(this); t.nextAll().removeClass(p.selected), w.addClass(p.selected), t.addClass(p.selected).prevAll().addClass(p.selected);
      }, mouseleave: function() {
        w.removeClass(p.selected), S.removeClass(p.selected);
      }, click: function() {
        const t=e(this); const n=f.get.rating(); const i=S.index(t)+1; ('auto'==m.clearable?1===S.length:m.clearable)&&n==i?f.clearRating():f.set.rating(i);
        ...
        const e=S.filter('.'+p.active).length; return f.verbose('Current rating retrieved', e), e;
      }}, set: {rating: function(e) {
        const t=e-1>=0?e-1:0; const n=S.eq(t); w.removeClass(p.selected), S.removeClass(p.selected).removeClass(p.active), e>0&&(f.verbose('Setting current rating to', e), n.prevAll().addBack().addClass(p.active)), f.is.initialLoad()||m.onRate.call(x, e);
      }, initialLoad: function() {
        d=!0;
      }}, setting: function(t, n) {
        if (f.debug('Changing setting', t, n), e.isPlainObject(t))e.extend(!0, m, t); else {
        ...
        let t; let n; m.performance&&(n=(t=(new Date).getTime())-(r||t), r=t, s.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': x, 'Execution Time': n})), clearTimeout(f.performance.timer), f.performance.timer=setTimeout(f.performance.display, 500);
      }, display: function() {
        let t=m.name+':'; let n=0; r=!1, clearTimeout(f.performance.timer), e.each(s, function(e, t) {
          n+=t['Execution Time'];
        ...
        let r; let s; let l; let c=C; return o=o||u, a=x||a, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
            if (c[a]!==i) return s=c[a], !1; if (!e.isPlainObject(c[o])||n==r) return c[o]!==i&&(s=c[o], !1); c=c[o];
          }
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.search=function(o) {
    let a; const r=e(this); const s=r.selector||''; let l=(new Date).getTime(); let c=[]; const u=arguments[0]; const d='string'==typeof u; const f=[].slice.call(arguments, 1); return e(this).each(function() {
      let m; const g=e.isPlainObject(o)?e.extend(!0, {}, e.fn.search.settings, o):e.extend({}, e.fn.search.settings); const p=g.className; const h=g.metadata; const v=g.regExp; const b=g.fields; const y=g.selector; const x=g.error; const C=g.namespace; const w='.'+C; const S=C+'-module'; const k=e(this); let T=k.find(y.prompt); let A=k.find(y.searchButton); let R=k.find(y.results); let P=k.find(y.result); const E=(k.find(y.category), this); let F=k.data(S); let O=!1; let D=!1; m={initialize: function() {
...
m.is.inMessage(e)||O?T.focus():(O=!1, m.is.animating()||m.is.hidden()||t());
        ...
        m.debug('Search result selected'); const i=e(this); const o=i.find(y.title).eq(0); const a=i.is('a[href]')?i:i.find('a[href]').eq(0); const r=a.attr('href')||!1; const s=a.attr('target')||!1; const l=(o.html(), o.length>0&&o.text()); const c=m.get.results(); const u=i.data(h.result)||m.get.result(l, c); if (e.isFunction(g.onSelect)&&!1===g.onSelect.call(E, u, c)) return m.debug('Custom onSelect callback cancelled default select action'), void(O=!0); m.hideResults(), l&&m.set.value(l), r&&(m.verbose('Opening search link found in result', a), '_blank'==s||n.ctrlKey?t.open(r):t.location.href=r);
      }}}, handleKeyboard: function(e) {
        let t; const n=k.find(y.result); const i=k.find(y.category); const o=n.filter('.'+p.active); const a=n.index(o); const r=n.length; const s=o.length>0; const l=e.which; const c=13; const u=38; const d=40; if (l==27&&(m.verbose('Escape key pressed, blurring search field'), m.hideResults(), D=!0), m.is.visible()) {
          if (l==c) {
        ...
        const i={debug: g.debug, on: !1, cache: g.cache, action: 'search', urlData: {query: t}, onSuccess: function(e) {
        ...
        if (t.target) {
          const i=e(t.target); return e.contains(n.documentElement, t.target)&&i.closest(y.message).length>0;
        }
      }, empty: function() {
        return ''===R.html();
      }, visible: function() {
        ...
        const e=T[0]; return e!==i&&e.oninput!==i?'input':e!==i&&e.onpropertychange!==i?'propertychange':'keyup';
      }, value: function() {
        return T.val();
      }, results: function() {
        return k.data(h.results);
      }, result: function(t, n) {
        const o=['title', 'id']; let a=!1; return t=t!==i?t:m.get.value(), n=n!==i?n:m.get.results(), 'category'===g.type?(m.debug('Finding result that matches', t), e.each(n, function(n, i) {
        ...
        const n=t.length; const i=e.length; if ('string'!=typeof e) return !1; if (e=e.toLowerCase(), t=t.toLowerCase(), i>n) return !1; if (i===n) return e===t; e:for (let o=0, a=0; o<i; o++) {
          for (let r=e.charCodeAt(o); a<n;) if (t.charCodeAt(a++)===r) continue e; return !1;
        } return !0;
      }, parse: {response: function(e, t) {
        const n=m.generateResults(e); m.verbose('Parsing server response', e), e!==i&&t!==i&&e[b.results]!==i&&(m.addResults(n), m.inject.id(e[b.results]), m.write.cache(t, {html: n, results: e[b.results]}), m.save.results(e[b.results]));
        ...
        const t=k.data(h.cache); e?e&&t&&t[e]&&(m.debug('Removing value from cache', e), delete t[e], k.data(h.cache, t)):(m.debug('Clearing cache', e), k.removeData(h.cache));
      }}, read: {cache: function(e) {
        const t=k.data(h.cache); return !!g.cache&&(m.verbose('Checking cache for generated html for query', e), 'object'==typeof t&&t[e]!==i&&t[e]);
      }}, create: {categoryResults: function(t) {
        const n={}; return e.each(t, function(e, t) {
        ...
        let n; const o=e+1; return t!==i?(n=String.fromCharCode(97+t)+o, m.verbose('Creating category result id', n)):(n=o, m.verbose('Creating result id', n)), n;
      }, results: function() {
        0===R.length&&(R=e('<div />').addClass(p.results).appendTo(k));
      }}, inject: {result: function(e, t, n) {
        m.verbose('Injecting result into results'); const o=n!==i?R.children().eq(n).children(y.results).first().children(y.result).eq(t):R.children(y.result).eq(t); m.verbose('Injecting results metadata', o), o.data(h.result, e);
      }, id: function(t) {
        m.debug('Injecting unique ids into results'); let n=0; let o=0; return 'category'===g.type?e.each(t, function(t, a) {
          o=0, e.each(a.results, function(e, t) {
            const r=a.results[e]; r.id===i&&(r.id=m.create.id(o, n)), m.inject.result(r, o, n), o++;
          }), n++;
        }):e.each(t, function(e, n) {
          const a=t[e]; a.id===i&&(a.id=m.create.id(o)), m.inject.result(a, o), o++;
        }), t;
      }}, save: {results: function(e) {
        m.verbose('Saving current search results to metadata', e), k.data(h.results, e);
      }}, write: {cache: function(e, t) {
        const n=k.data(h.cache)!==i?k.data(h.cache):{}; g.cache&&(m.verbose('Writing generated html to cache', e, t), n[e]=t, k.data(h.cache, n));
        ...
        m.debug('Generating html from response', t); const n=g.templates[g.type]; const i=e.isPlainObject(t[b.results])&&!e.isEmptyObject(t[b.results]); const o=e.isArray(t[b.results])&&t[b.results].length>0; let a=''; return i||o?(g.maxResults>0&&(i?'standard'==g.type&&m.error(x.maxResults):t[b.results]=t[b.results].slice(0, g.maxResults)), e.isFunction(n)?a=n(t, b):m.error(x.noTemplate, !1)):g.showNoResults&&(a=m.displayMessage(x.noResults, 'empty')), g.onResults.call(E, t), a;
        ...
        let t; let n; g.performance&&(n=(t=(new Date).getTime())-(l||t), l=t, c.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': E, 'Execution Time': n})), clearTimeout(m.performance.timer), m.performance.timer=setTimeout(m.performance.display, 500);
      }, display: function() {
        let t=g.name+':'; let n=0; l=!1, clearTimeout(m.performance.timer), e.each(c, function(e, t) {
          n+=t['Execution Time'];
        ...
        let r; let s; let l; let c=F; return n=n||f, o=E||o, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
            if (c[a]!==i) return s=c[a], !1; if (!e.isPlainObject(c[o])||n==r) return c[o]!==i&&(s=c[o], !1); c=c[o];
          }
        })), e.isFunction(s)?l=s.apply(o, n):s!==i&&(l=s), e.isArray(a)?a.push(l):a!==i?a=[a, l]:l!==i&&(a=l), s;
    ...
    let n=''; return e!==i&&t!==i&&(n+='<div class="message '+t+'">', n+='empty'==t?'<div class="header">No Results</div class="header"><div class="description">'+e+'</div class="description">':' <div class="description">'+e+'</div>', n+='</div>'), n;
  }, category: function(t, n) {
    let o=''; e.fn.search.settings.templates.escape; return t[n.categoryResults]!==i&&(e.each(t[n.categoryResults], function(t, a) {
...
t[n.url]?o+='<a class="result" href="'+t[n.url]+'">':o+='<a class="result">', t[n.image]!==i&&(o+='<div class="image"> <img src="'+t[n.image]+'"></div>'), o+='<div class="content">', t[n.price]!==i&&(o+='<div class="price">'+t[n.price]+'</div>'), t[n.title]!==i&&(o+='<div class="title">'+t[n.title]+'</div>'), t[n.description]!==i&&(o+='<div class="description">'+t[n.description]+'</div>'), o+='</div>', o+='</a>';
    ...
    let o=''; return t[n.results]!==i&&(e.each(t[n.results], function(e, t) {
t[n.url]?o+='<a class="result" href="'+t[n.url]+'">':o+='<a class="result">', t[n.image]!==i&&(o+='<div class="image"> <img src="'+t[n.image]+'"></div>'), o+='<div class="content">', t[n.price]!==i&&(o+='<div class="price">'+t[n.price]+'</div>'), t[n.title]!==i&&(o+='<div class="title">'+t[n.title]+'</div>'), t[n.description]!==i&&(o+='<div class="description">'+t[n.description]+'</div>'), o+='</div>', o+='</a>';
    }), t[n.action]&&(o+='<a href="'+t[n.action][n.actionURL]+'" class="action">'+t[n.action][n.actionText]+'</a>'), o);
  }}};
}(jQuery, window, document), function(e, t, n, i) {
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.shape=function(o) {
    let a; const r=e(this); let s=(e('body'), (new Date).getTime()); let l=[]; const c=arguments[0]; const u='string'==typeof c; const d=[].slice.call(arguments, 1); const f=t.requestAnimationFrame||t.mozRequestAnimationFrame||t.webkitRequestAnimationFrame||t.msRequestAnimationFrame||function(e) {
      setTimeout(e, 0);
    }; return r.each(function() {
      let t; let m; let g; const p=r.selector||''; const h=e.isPlainObject(o)?e.extend(!0, {}, e.fn.shape.settings, o):e.extend({}, e.fn.shape.settings); const v=h.namespace; const b=h.selector; const y=h.error; const x=h.className; const C='.'+v; const w='module-'+v; let S=e(this); let k=S.find(b.sides); let T=S.find(b.side); let A=!1; const R=this; let P=S.data(w); g={initialize: function() {
        ...
        const e=S.find('.'+h.className.active); const t=e.outerWidth(!0); const n=e.outerHeight(!0); S.css({width: t, height: n});
      }, stageSize: function() {
        const e=S.clone().addClass(x.loading); const t=e.find('.'+h.className.active); const n=A?e.find(b.side).eq(A):t.next(b.side).length>0?t.next(b.side):e.find(b.side).first(); const i='next'==h.width?n.outerWidth(!0):'initial'==h.width?S.width():h.width; const o='next'==h.height?n.outerHeight(!0):'initial'==h.height?S.height():h.height; t.removeClass(x.active), n.addClass(x.active), e.insertAfter(S), e.remove(), 'auto'!=h.width&&(S.css('width', i+h.jitter), g.verbose('Specifying width during animation', i)), 'auto'!=h.height&&(S.css('height', o+h.jitter), g.verbose('Specifying height during animation', o));
      }, nextSide: function(e) {
        ...
        if (!g.is.complete()||g.is.animating()||h.allowRepeats) {
          if (g.is.animating())g.queue('flip up'); else {
            g.debug('Flipping up', m); const e=g.get.transform.up(); g.set.stageSize(), g.stage.above(), g.animate(e);
          }
        } else g.debug('Side already visible', m);
      }, down: function() {
        if (!g.is.complete()||g.is.animating()||h.allowRepeats) {
          if (g.is.animating())g.queue('flip down'); else {
            g.debug('Flipping down', m); const e=g.get.transform.down(); g.set.stageSize(), g.stage.below(), g.animate(e);
          }
        } else g.debug('Side already visible', m);
      }, left: function() {
        if (!g.is.complete()||g.is.animating()||h.allowRepeats) {
          if (g.is.animating())g.queue('flip left'); else {
            g.debug('Flipping left', m); const e=g.get.transform.left(); g.set.stageSize(), g.stage.left(), g.animate(e);
          }
        } else g.debug('Side already visible', m);
      }, right: function() {
        if (!g.is.complete()||g.is.animating()||h.allowRepeats) {
          if (g.is.animating())g.queue('flip right'); else {
            g.debug('Flipping right', m); const e=g.get.transform.right(); g.set.stageSize(), g.stage.right(), g.animate(e);
          }
        } else g.debug('Side already visible', m);
      }, over: function() {
...
!g.is.complete()||g.is.animating()||h.allowRepeats?g.is.animating()?g.queue('flip back'):(g.debug('Flipping back', m), g.set.stageSize(), g.stage.behind(), g.animate(g.get.transform.back())):g.debug('Side already visible', m);
        ...
        const e=t.outerWidth(!0); const n=m.outerWidth(!0); const i={origin: (e-n)/2, depth: {active: n/2, next: e/2}}; g.verbose('Setting the initial animation position as left', m, i), k.css({transform: 'translateZ(-'+i.depth.active+'px)'}), t.css({transform: 'rotateY(0deg) translateZ('+i.depth.active+'px)'}), m.addClass(x.animating).css({left: i.origin+'px', transform: 'rotateY(-90deg) translateZ('+i.depth.next+'px)'});
      }, right: function() {
        const e=t.outerWidth(!0); const n=m.outerWidth(!0); const i={origin: (e-n)/2, depth: {active: n/2, next: e/2}}; g.verbose('Setting the initial animation position as left', m, i), k.css({transform: 'translateZ(-'+i.depth.active+'px)'}), t.css({transform: 'rotateY(0deg) translateZ('+i.depth.active+'px)'}), m.addClass(x.animating).css({left: i.origin+'px', transform: 'rotateY(90deg) translateZ('+i.depth.next+'px)'});
      }, behind: function() {
        const e=t.outerWidth(!0); const n=m.outerWidth(!0); const i={origin: (e-n)/2, depth: {active: n/2, next: e/2}}; g.verbose('Setting the initial animation position as behind', m, i), t.css({transform: 'rotateY(0deg)'}), m.addClass(x.animating).css({left: i.origin+'px', transform: 'rotateY(-180deg)'});
      }}, setting: function(t, n) {
        ...
        let t; let n; h.performance&&(n=(t=(new Date).getTime())-(s||t), s=t, l.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': R, 'Execution Time': n})), clearTimeout(g.performance.timer), g.performance.timer=setTimeout(g.performance.display, 500);
      }, display: function() {
        let t=h.name+':'; let n=0; s=!1, clearTimeout(g.performance.timer), e.each(l, function(e, t) {
          n+=t['Execution Time'];
        ...
        let r; let s; let l; let c=P; return n=n||d, o=R||o, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
            if (c[a]!==i) return s=c[a], !1; if (!e.isPlainObject(c[o])||n==r) return c[o]!==i&&(s=c[o], !1); c=c[o];
          }
        })), e.isFunction(s)?l=s.apply(o, n):s!==i&&(l=s), e.isArray(a)?a.push(l):a!==i?a=[a, l]:l!==i&&(a=l), s;
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.sidebar=function(o) {
    let a; const r=e(this); const s=e(t); const l=e(n); const c=e('html'); const u=e('head'); const d=r.selector||''; let f=(new Date).getTime(); let m=[]; const g=arguments[0]; const p='string'==typeof g; const h=[].slice.call(arguments, 1); const v=t.requestAnimationFrame||t.mozRequestAnimationFrame||t.webkitRequestAnimationFrame||t.msRequestAnimationFrame||function(e) {
      setTimeout(e, 0);
    }; return r.each(function() {
      let r; let b; let y; let x; let C; let w; const S=e.isPlainObject(o)?e.extend(!0, {}, e.fn.sidebar.settings, o):e.extend({}, e.fn.sidebar.settings); const k=S.selector; const T=S.className; const A=S.namespace; const R=S.regExp; const P=S.error; const E='.'+A; const F='module-'+A; const O=e(this); let D=e(S.context); let q=O.children(k.sidebar); let j=(D.children(k.fixed), D.children(k.pusher)); const z=this; let I=O.data(F); w={initialize: function() {
        ...
        const t=j.find(e.target).length>0||j.is(e.target); const n=D.is(e.target); t&&(w.verbose('User clicked on dimmed page'), w.hide()), n&&(w.verbose('User clicked on dimmable context (scaled out page)'), w.hide());
        ...
        const i=e(t); n=e.isFunction(w[n])?w[n]:w.toggle, i.length>0?(w.debug('Attaching sidebar events to element', t, n), i.on('click'+E, n)):w.error(P.notFound, t);
      }, show: function(t) {
        ...
        const t=q.not(O).filter('.'+T.visible); const n=t.length; let i=0; e=e||function() {}, t.sidebar('hide', function() {
          ++i==n&&e();
        });
      }, toggle: function() {
        w.verbose('Determining toggled direction'), w.is.hidden()?w.show():w.hide();
      }, pushPage: function(t) {
        let n; let i; let o; const a=w.get.transition(); const r='overlay'===a||w.othersActive()?O:j; t=e.isFunction(t)?t:function() {}, 'scale down'==S.transition&&w.scrollToTop(), w.set.transition(a), w.repaint(), n=function() {
        ...
        let n; let i; const o=w.get.transition(); const a='overlay'==o||w.othersActive()?O:j; t=e.isFunction(t)?t:function() {}, w.verbose('Removing context push state', w.get.direction()), w.unbind.clickaway(), w.unbind.scrollLock(), n=function() {
        ...
        let e; const t=w.get.direction(); return e=w.is.mobile()?'auto'==S.mobileTransition?S.defaultTransition.mobile[t]:S.mobileTransition:'auto'==S.transition?S.defaultTransition.computer[t]:S.transition, w.verbose('Determined transition', e), e;
      }, transitionEvent: function() {
        let e; const t=n.createElement('element'); const o={transition: 'transitionend', OTransition: 'oTransitionEnd', MozTransition: 'transitionend', WebkitTransition: 'webkitTransitionEnd'}; for (e in o) if (t.style[e]!==i) return o[e];
      }}, is: {ie: function() {
        return !t.ActiveXObject&&'ActiveXObject'in t||'ActiveXObject'in t;
      }, ios: function() {
        const e=navigator.userAgent; const t=e.match(R.ios); const n=e.match(R.mobileChrome); return !(!t||n)&&(w.verbose('Browser was found to be iOS', e), !0);
      }, mobile: function() {
        const e=navigator.userAgent; return e.match(R.mobile)?(w.verbose('Browser was found to be mobile', e), !0):(w.verbose('Browser is not mobile, using regular transition', e), !1);
      }, hidden: function() {
        return !w.is.visible();
      }, visible: function() {
        ...
        let t; let n; S.performance&&(n=(t=(new Date).getTime())-(f||t), f=t, m.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': z, 'Execution Time': n})), clearTimeout(w.performance.timer), w.performance.timer=setTimeout(w.performance.display, 500);
      }, display: function() {
        let t=S.name+':'; let n=0; f=!1, clearTimeout(w.performance.timer), e.each(m, function(e, t) {
          n+=t['Execution Time'];
        ...
        let r; let s; let l; let c=I; return n=n||h, o=z||o, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.sticky=function(o) {
    let a; const r=e(this); const s=r.selector||''; let l=(new Date).getTime(); let c=[]; const u=arguments[0]; const d='string'==typeof u; const f=[].slice.call(arguments, 1); return r.each(function() {
      let r; let m; let g; let p; let h; const v=e.isPlainObject(o)?e.extend(!0, {}, e.fn.sticky.settings, o):e.extend({}, e.fn.sticky.settings); const b=v.className; const y=v.namespace; const x=v.error; const C='.'+y; const w='module-'+y; const S=e(this); const k=e(t); const T=e(v.scrollContext); let A=(S.selector, S.data(w)); const R=t.requestAnimationFrame||t.mozRequestAnimationFrame||t.webkitRequestAnimationFrame||t.msRequestAnimationFrame||function(e) {
        setTimeout(e, 0);
      }; const P=this; h={initialize: function() {
        ...
        const t=e('<div/>'); t[0]; return t.addClass(b.supported), t.css('position').match('sticky');
      }}, save: {lastScroll: function(e) {
        h.lastScroll=e;
      }, elementScroll: function(e) {
        h.elementScroll=e;
      }, positions: function() {
        const e={height: T.height()}; const t={margin: {top: parseInt(S.css('margin-top'), 10), bottom: parseInt(S.css('margin-bottom'), 10)}, offset: S.offset(), width: S.outerWidth(), height: S.outerHeight()}; const n={offset: m.offset(), height: m.outerHeight()}; r.outerHeight(); h.is.standardScroll()||(h.debug('Non-standard scroll. Removing scroll offset from element offset'), e.top=T.scrollTop(), e.left=T.scrollLeft(), t.offset.top+=e.top, n.offset.top+=e.top, t.offset.left+=e.left, n.offset.left+=e.left), h.cache={fits: t.height+v.offset<=e.height, sameHeight: t.height==n.height, scrollContext: {height: e.height}, element: {margin: t.margin, top: t.offset.top-t.margin.top, left: t.offset.left, width: t.width, height: t.height, bottom: t.offset.top+t.height}, context: {top: n.offset.top, height: n.height, bottom: n.offset.top+n.height}}, h.set.containerSize(), h.stick(), h.debug('Caching element positions', h.cache);
      }}, get: {direction: function(e) {
        let t='down'; return e=e||T.scrollTop(), h.lastScroll!==i&&(h.lastScroll<e?t='down':h.lastScroll>e&&(t='up')), t;
        ...
        e=e||T.scrollTop(); const t=h.cache.element; const n=h.cache.scrollContext; const i=h.get.scrollChange(e); const o=t.height-n.height+v.offset; let a=h.get.currentElementScroll(); const r=a+i; return a=h.cache.fits||r<0?0:r>o?o:r;
        ...
        const e=r.get(0).tagName; 'HTML'===e||'body'==e?h.determineContainer():Math.abs(r.outerHeight()-h.cache.context.height)>v.jitter&&(h.debug('Context has padding, specifying exact height for container', h.cache.context.height), r.css({height: h.cache.context.height}));
      }, minimumSize: function() {
        const e=h.cache.element; r.css('min-height', e.height);
      }, scroll: function(e) {
        ...
        const t=e||T.scrollTop(); const n=h.cache; const i=n.fits; const o=n.sameHeight; const a=n.element; const r=n.scrollContext; const s=n.context; const l=h.is.bottom()&&v.pushing?v.bottomOffset:v.offset; const c=(e={top: t+l, bottom: t+l+r.height}, h.get.direction(e.top), i?0:h.get.elementScroll(e.top)); const u=!i; 0!==a.height&&!o&&(h.is.initialPosition()?e.top>=s.bottom?(h.debug('Initial element position is bottom of container'), h.bindBottom()):e.top>a.top&&(a.height+e.top-c>=s.bottom?(h.debug('Initial element position is bottom of container'), h.bindBottom()):(h.debug('Initial element position is fixed'), h.fixTop())):h.is.fixed()?h.is.top()?e.top<=a.top?(h.debug('Fixed element reached top of container'), h.setInitialPosition()):a.height+e.top-c>=s.bottom?(h.debug('Fixed element reached bottom of container'), h.bindBottom()):u&&(h.set.scroll(c), h.save.lastScroll(e.top), h.save.elementScroll(c)):h.is.bottom()&&(e.bottom-a.height<=a.top?(h.debug('Bottom fixed rail has reached top of container'), h.setInitialPosition()):e.bottom>=s.bottom?(h.debug('Bottom fixed rail has reached bottom of container'), h.bindBottom()):u&&(h.set.scroll(c), h.save.lastScroll(e.top), h.save.elementScroll(c))):h.is.bottom()&&(e.top<=a.top?(h.debug('Jumped from bottom fixed to top fixed, most likely used home/end button'), h.setInitialPosition()):v.pushing?h.is.bound()&&e.bottom<=s.bottom&&(h.debug('Fixing bottom attached element to bottom of browser.'), h.fixBottom()):h.is.bound()&&e.top<=s.bottom-a.height&&(h.debug('Fixing bottom attached element to top of browser.'), h.fixTop())));
      }, bindTop: function() {
        ...
        let t; let n; v.performance&&(n=(t=(new Date).getTime())-(l||t), l=t, c.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': P, 'Execution Time': n})), clearTimeout(h.performance.timer), h.performance.timer=setTimeout(h.performance.display, 0);
      }, display: function() {
        let t=v.name+':'; let n=0; l=!1, clearTimeout(h.performance.timer), e.each(c, function(e, t) {
          n+=t['Execution Time'];
        }), t+=' '+n+'ms', s&&(t+=' \''+s+'\''), (console.group!==i||console.table!==i)&&c.length>0&&(console.groupCollapsed(t), console.table?console.table(c):e.each(c, function(e, t) {
          console.log(t.Name+': '+t['Execution Time']+'ms');
        }), console.groupEnd()), c=[];
      }}, invoke: function(t, n, o) {
        let r; let s; let l; let c=A; return n=n||f, o=P||o, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
            if (c[a]!==i) return s=c[a], !1; if (!e.isPlainObject(c[o])||n==r) return c[o]!==i&&(s=c[o], !1); c=c[o];
          }
        })), e.isFunction(s)?l=s.apply(o, n):s!==i&&(l=s), e.isArray(a)?a.push(l):a!==i?a=[a, l]:l!==i&&(a=l), s;
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.tab=function(o) {
    let a; const r=e.isFunction(this)?e(t):e(this); const s=r.selector||''; let l=(new Date).getTime(); let c=[]; const u=arguments[0]; const d='string'==typeof u; const f=[].slice.call(arguments, 1); let m=!1; return r.each(function() {
      let g; let p; let h; let v; let b; let y; let x=e.isPlainObject(o)?e.extend(!0, {}, e.fn.tab.settings, o):e.extend({}, e.fn.tab.settings); const C=x.className; const w=x.metadata; const S=x.selector; const k=x.error; const T='.'+x.namespace; const A='module-'+x.namespace; const R=e(this); const P={}; let E=!0; let F=0; const O=this; let D=R.data(A); b={initialize: function() {
        ...
        let t; 'parent'===x.context?(R.closest(S.ui).length>0?(t=R.closest(S.ui), b.verbose('Using closest UI element as parent', t)):t=R, g=t.parent(), b.verbose('Determined parent element for creating context', g)):x.context?(g=e(x.context), b.verbose('Using selector for tab context', x.context, g)):g=e('body'), x.childrenOnly?(p=g.children(S.tabs), b.debug('Searching tab context children for tabs', g, p)):(p=g.find(S.tabs), b.debug('Searching tab context for tabs', g, p));
        ...
        const n=e(this).data(w.tab); n!==i?(x.history?(b.verbose('Updating page state', t), e.address.value(n)):(b.verbose('Changing tab', t), b.changeTab(n)), t.preventDefault()):b.debug('No tab specified');
      }, history: {change: function(t) {
        const n=t.pathNames.join('/')||b.get.initialPath(); const o=x.templates.determineTitle(n)||!1; b.performance.display(), b.debug('History change event', n, t), y=t, n!==i&&b.changeTab(n), o&&e.address.title(o);
      }}}, refresh: function() {
        ...
        const t='string'==typeof x.path?x.path.replace(/\/$/, '')+'/{$tab}':'/{$tab}'; b.verbose('Setting up automatic tab retrieval from server', t), e.isPlainObject(x.apiSettings)?x.apiSettings.url=t:x.apiSettings={url: t};
      }, loading: function(e) {
        const t=b.get.tabElement(e); t.hasClass(C.loading)||(b.verbose('Setting loading state for', t), t.addClass(C.loading).siblings(p).removeClass(C.active+' '+C.loading), t.length>0&&x.onRequest.call(t[0], e));
      }, state: function(t) {
        e.address.value(t);
      }}, changeTab: function(n) {
        const i=t.history&&t.history.pushState&&x.ignoreFirstLoad&&E; const o=x.auto||e.isPlainObject(x.apiSettings); const a=o&&!i?b.utilities.pathToArray(n):b.get.defaultPathArray(n); n=b.utilities.arrayToPath(a), e.each(a, function(t, r) {
          let s; let l; let c; let u; const d=a.slice(0, t+1); let f=b.utilities.arrayToPath(d); const m=b.is.tab(f); const p=t+1==a.length; let S=b.get.tabElement(f); if (b.verbose('Looking for tab', r), m) {
            ...
            if (-1!=n.search('/')||''===n) return b.error(k.missingTab, R, g, f), !1; if (f=(s=e('#'+n+', a[name="'+n+'"]')).closest('[data-tab]').data(w.tab), S=b.get.tabElement(f), s&&s.length>0&&f) {
              return b.debug('Anchor link used, opening parent tab', S, s), S.hasClass(C.active)||setTimeout(function() {
                b.scrollTo(s);
        ...
        const i=!!(t&&t.length>0)&&t.offset().top; !1!==i&&(b.debug('Forcing scroll to an in-page link in a hidden tab', i, t), e(n).scrollTop(i));
      }, update: {content: function(t, n, o) {
        const a=b.get.tabElement(t); const r=a[0]; o=o!==i?o:x.evaluateScripts, 'string'==typeof x.cacheType&&'dom'==x.cacheType.toLowerCase()&&'string'!=typeof n?a.empty().append(e(n).clone(!0)):o?(b.debug('Updating HTML and evaluating inline scripts', t, n), a.html(n)):(b.debug('Updating HTML', t, n), r.innerHTML=n);
      }}, fetch: {content: function(t, n) {
        let o; let a; const r=b.get.tabElement(t); const s={dataType: 'html', encodeParameters: !1, on: 'now', cache: x.alwaysRefresh, headers: {'X-Remote': !0}, onSuccess: function(e) {
          'response'==x.cacheType&&b.cache.add(n, e), b.update.content(t, e), t==h?(b.debug('Content loaded', t), b.activate.tab(t)):b.debug('Content loaded in background', t), x.onFirstLoad.call(r[0], t, v, y), x.onLoad.call(r[0], t, v, y), x.loadOnce?b.cache.add(n, !0):'string'==typeof x.cacheType&&'dom'==x.cacheType.toLowerCase()&&r.children().length>0?setTimeout(function() {
            let e=r.children().clone(!0); e=e.not('script'), b.cache.add(n, e);
          }, 0):b.cache.add(n, r.html());
        }, urlData: {tab: n}}; const l=r.api('get request')||!1; const c=l&&'pending'===l.state(); n=n||t, a=b.cache.read(n), x.cache&&a?(b.activate.tab(t), b.debug('Adding cached content', n), x.loadOnce||('once'==x.evaluateScripts?b.update.content(t, a, !1):b.update.content(t, a)), x.onLoad.call(r[0], t, v, y)):c?(b.set.loading(t), b.debug('Content is already loading', n)):e.api!==i?(o=e.extend(!0, {}, x.apiSettings, s), b.debug('Retrieving remote content', n, o), b.set.loading(t), r.api(o)):b.error(k.api);
      }}, activate: {all: function(e) {
        b.activate.tab(e), b.activate.navigation(e);
      }, tab: function(e) {
        const t=b.get.tabElement(e); const n='siblings'==x.deactivate?t.siblings(p):p.not(t); const i=t.hasClass(C.active); b.verbose('Showing tab content for', t), i||(t.addClass(C.active), n.removeClass(C.active+' '+C.loading), t.length>0&&x.onVisible.call(t[0], e));
      }, navigation: function(e) {
        const t=b.get.navElement(e); const n='siblings'==x.deactivate?t.siblings(r):r.not(t); const i=t.hasClass(C.active); b.verbose('Activating tab navigation for', t, e), i||(t.addClass(C.active), n.removeClass(C.active+' '+C.loading));
        ...
        const t=r.filter('[data-'+w.tab+'^="'+e+'/"]').eq(0).data(w.tab)||!1; if (t) {
        ...
        let t; let n; let i; let o; return e=e||h, i=b.utilities.pathToArray(e), o=b.utilities.last(i), t=p.filter('[data-'+w.tab+'="'+e+'"]'), n=p.filter('[data-'+w.tab+'="'+o+'"]'), t.length>0?t:n;
      }, tab: function() {
        return h;
        ...
        let t; let n; x.performance&&(n=(t=(new Date).getTime())-(l||t), l=t, c.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': O, 'Execution Time': n})), clearTimeout(b.performance.timer), b.performance.timer=setTimeout(b.performance.display, 500);
      }, display: function() {
        let t=x.name+':'; let n=0; l=!1, clearTimeout(b.performance.timer), e.each(c, function(e, t) {
          n+=t['Execution Time'];
        }), t+=' '+n+'ms', s&&(t+=' \''+s+'\''), (console.group!==i||console.table!==i)&&c.length>0&&(console.groupCollapsed(t), console.table?console.table(c):e.each(c, function(e, t) {
          console.log(t.Name+': '+t['Execution Time']+'ms');
        }), console.groupEnd()), c=[];
      }}, invoke: function(t, n, o) {
        let r; let s; let l; let c=D; return n=n||f, o=O||o, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.transition=function() {
    let o; const a=e(this); const r=a.selector||''; let s=(new Date).getTime(); let l=[]; const c=arguments; const u=c[0]; const d=[].slice.call(arguments, 1); let f='string'==typeof u; t.requestAnimationFrame||t.mozRequestAnimationFrame||t.webkitRequestAnimationFrame||t.msRequestAnimationFrame; return a.each(function(t) {
      let m; let g; let p; let h; let v; let b; let y; let x; let C; const w=e(this); const S=this; (C={initialize: function() {
        ...
        C.verbose('Forcing element repaint'); const e=w.parent(); const t=w.next(); 0===t.length?w.detach().appendTo(e):w.detach().insertBefore(t);
      }, repaint: function() {
        C.verbose('Repainting element'); S.offsetWidth;
      }, delay: function(e) {
        let n; let o=C.get.animationDirection(); o||(o=C.can.transition()?C.get.direction():'static'), e=e!==i?e:m.interval, n='auto'==m.reverse&&o==h.outward||1==m.reverse?(a.length-t)*m.interval:t*m.interval, C.debug('Delaying animation by', n), setTimeout(C.animate, n);
      }, animate: function(e) {
        ...
        const e=w.attr('style'); const t=C.get.userStyle(); const n=C.get.displayType(); const o=t+'display: '+n+' !important;'; const a=w.css('display'); const r=e===i||''===e; a!==n?(C.verbose('Overriding default display to show element', n), w.attr('style', o)):r&&w.removeAttr('style');
      }, hidden: function() {
        const e=w.attr('style'); const t=w.css('display'); const n=e===i||''===e; 'none'===t||C.is.hidden()?n&&w.removeAttr('style'):(C.verbose('Overriding default display to hide element'), w.css('display', 'none'));
      }}, has: {direction: function(t) {
        let n=!1; return 'string'==typeof(t=t||m.animation)&&(t=t.split(' '), e.each(t, function(e, t) {
          t!==h.inward&&t!==h.outward||(n=!0);
        })), n;
      }, inlineDisplay: function() {
        const t=w.attr('style')||''; return e.isArray(t.match(/display.*?;/, ''));
      }}, set: {animating: function(e) {
        let t; C.remove.completeCallback(), e=e||m.animation, t=C.get.animationClass(e), C.save.animation(t), C.force.visible(), C.remove.hidden(), C.remove.direction(), C.start.animation(t);
...
(e=e||C.get.direction())==h.inward?C.set.inward():C.set.outward();
        ...
        const e=C.get.currentAnimation(); e&&(w.removeClass(e), C.verbose('Removing animation class', C.cache)), C.remove.duration();
      }}, add: {failSafe: function() {
        const e=C.get.duration(); C.timer=setTimeout(function() {
          w.triggerHandler(b);
        ...
        const t=e||m.animation; const n=C.can.transition()&&!C.has.direction()?C.get.direction()+' ':''; return h.animating+' '+h.transition+' '+n+t;
        ...
        let n; return 'string'==typeof(t=t||m.animation)&&(t=t.split(' '), e.each(t, function(e, t) {
t===h.inward?n=h.inward:t===h.outward&&(n=h.outward);
        ...
        let e; const t=n.createElement('div'); const o={animation: 'animationstart', OAnimation: 'oAnimationStart', MozAnimation: 'mozAnimationStart', WebkitAnimation: 'webkitAnimationStart'}; for (e in o) if (t.style[e]!==i) return o[e]; return !1;
      }, animationEndEvent: function() {
        let e; const t=n.createElement('div'); const o={animation: 'animationend', OAnimation: 'oAnimationEnd', MozAnimation: 'mozAnimationEnd', WebkitAnimation: 'webkitAnimationEnd'}; for (e in o) if (t.style[e]!==i) return o[e]; return !1;
      }}, can: {transition: function(t) {
        let n; let o; let a; let r; let s; let l; const c=m.animation; const u=C.get.transitionExists(c); let d=C.get.displayType(!1); if (u===i||t) {
...
C.is.visible()?C.hide():C.show();
        ...
        let t; let n; m.performance&&(n=(t=(new Date).getTime())-(s||t), s=t, l.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': S, 'Execution Time': n})), clearTimeout(C.performance.timer), C.performance.timer=setTimeout(C.performance.display, 500);
      }, display: function() {
        let t=m.name+':'; let n=0; s=!1, clearTimeout(C.performance.timer), e.each(l, function(e, t) {
          n+=t['Execution Time'];
        }), t+=' '+n+'ms', r&&(t+=' \''+r+'\''), a.length>1&&(t+=' ('+a.length+')'), (console.group!==i||console.table!==i)&&l.length>0&&(console.groupCollapsed(t), console.table?console.table(l):e.each(l, function(e, t) {
          console.log(t.Name+': '+t['Execution Time']+'ms');
        }), console.groupEnd()), l=[];
      }}, invoke: function(t, n, a) {
        let r; let s; let l; let c=g; return n=n||d, a=S||a, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
            if (c[a]!==i) return s=c[a], !1; if (!e.isPlainObject(c[o])||n==r) return c[o]!==i&&(s=c[o], !1); c=c[o];
          }
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(); e.api=e.fn.api=function(n) {
    let o; const a=e.isFunction(this)?e(t):e(this); const r=a.selector||''; let s=(new Date).getTime(); let l=[]; const c=arguments[0]; const u='string'==typeof c; const d=[].slice.call(arguments, 1); return a.each(function() {
      let a; let f; let m; let g; let p; let h; const v=e.isPlainObject(n)?e.extend(!0, {}, e.fn.api.settings, n):e.extend({}, e.fn.api.settings); const b=v.namespace; const y=v.metadata; const x=v.selector; const C=v.error; const w=v.className; const S='.'+b; const k='module-'+b; const T=e(this); const A=T.closest(x.form); const R=v.stateContext?e(v.stateContext):T; const P=this; const E=R[0]; let F=T.data(k); h={initialize: function() {
        ...
        const e=h.get.event(); e?(h.verbose('Attaching API events to element', e), T.on(e+S, h.event.trigger)):'now'==v.on&&(h.debug('Querying API endpoint immediately'), h.query());
        ...
        let n; if (t.Storage!==i) return n=sessionStorage.getItem(e), h.debug('Using cached response', e, n), n=h.decode.json(n); h.error(C.noStorage);
...
o&&''===o?h.debug('Response empty, not caching', o):t.Storage!==i?(e.isPlainObject(o)&&(o=JSON.stringify(o)), sessionStorage.setItem(n, o), h.verbose('Storing cached response for url', n, o)):h.error(C.noStorage);
        ...
        let o; let a; return t&&(o=t.match(v.regExp.required), a=t.match(v.regExp.optional), n=n||v.urlData, o&&(h.debug('Looking for required URL variables', o), e.each(o, function(o, a) {
          const r=-1!==a.indexOf('$')?a.substr(2, a.length-3):a.substr(1, a.length-2); let s=e.isPlainObject(n)&&n[r]!==i?n[r]:T.data(r)!==i?T.data(r):R.data(r)!==i?R.data(r):n[r]; if (s===i) return h.error(C.requiredParameter, r, t), t=!1, !1; h.verbose('Found required variable', r, s), s=v.encodeParameters?h.get.urlEncodedValue(s):s, t=t.replace(a, s);
        })), a&&(h.debug('Looking for optional URL variables', o), e.each(a, function(o, a) {
          const r=-1!==a.indexOf('$')?a.substr(3, a.length-4):a.substr(2, a.length-3); const s=e.isPlainObject(n)&&n[r]!==i?n[r]:T.data(r)!==i?T.data(r):R.data(r)!==i?R.data(r):n[r]; s!==i?(h.verbose('Optional variable Found', r, s), t=t.replace(a, s)):(h.verbose('Optional variable not found', r), t=-1!==t.indexOf('/'+a)?t.replace('/'+a, ''):t.replace(a, ''));
        }))), t;
      }, formData: function(t) {
        const n=e.fn.serializeObject!==i; const o=n?A.serializeObject():A.serialize(); return t=t||v.data, e.isPlainObject(t)?n?(h.debug('Extending existing data with form data', t, o), t=e.extend(!0, {}, t, o)):(h.error(C.missingSerialize), h.debug('Cant extend data. Replacing data with form data', t, o), t=o):(h.debug('Adding form data', o), t=o), t;
        ...
        const o=this; const a=(new Date).getTime()-p; let r=v.loadingDuration-a; const s=!!e.isFunction(v.onResponse)&&(h.is.expectingJSON()?v.onResponse.call(o, e.extend(!0, {}, t)):v.onResponse.call(o, t)); r=r>0?r:0, s&&(h.debug('Modified API response in onResponse callback', v.onResponse, s, t), t=s), r>0&&h.debug('Response completed early delaying state change by', r), setTimeout(function() {
h.is.validResponse(t)?h.request.resolveWith(o, [t, i]):h.request.rejectWith(o, [i, 'invalid']);
        }, r);
      }, fail: function(e, t, n) {
        const i=this; const o=(new Date).getTime()-p; let a=v.loadingDuration-o; (a=a>0?a:0)>0&&h.debug('Response completed early delaying state change by', a), setTimeout(function() {
h.is.abortedRequest(e)?h.request.rejectWith(i, [e, 'aborted', n]):h.request.rejectWith(i, [e, 'error', t, n]);
        ...
        let n; let i; h.was.succesful()?(i=e, n=t):(n=e, i=h.get.responseFromXHR(n)), h.remove.loading(), v.onComplete.call(E, i, T, n);
      }, fail: function(e, t, n) {
        const o=h.get.responseFromXHR(e); const r=h.get.errorFromRequest(o, t, n); if ('aborted'==t) return h.debug('XHR Aborted (Most likely caused by page navigation or CORS Policy)', t, n), v.onAbort.call(E, t, T, e), !0; 'invalid'==t?h.debug('JSON did not pass success test. A server-side error has most likely occurred', o):'error'==t&&e!==i&&(h.debug('XHR produced a server error', t, n), 200!=e.status&&n!==i&&''!==n&&h.error(C.statusMessage+n, a.url), v.onError.call(E, r, T, e)), v.errorDuration&&'aborted'!==t&&(h.debug('Adding error state'), h.set.error(), h.should.removeError()&&setTimeout(h.remove.error, v.errorDuration)), h.debug('API Request failed', r, e), v.onFailure.call(E, o, T, e);
      }}}, create: {request: function() {
        return e.Deferred().always(h.event.request.complete).done(h.event.request.done).fail(h.event.request.fail);
      }, mockedXHR: function() {
        let t; let n; let i; const o=v.mockResponse||v.response; const a=v.mockResponseAsync||v.responseAsync; return i=e.Deferred().always(h.event.xhr.complete).done(h.event.xhr.done).fail(h.event.xhr.fail), o?(e.isFunction(o)?(h.debug('Using specified synchronous callback', o), n=o.call(E, f)):(h.debug('Using settings specified response', o), n=o), i.resolveWith(E, [n, !1, {responseText: n}])):e.isFunction(a)&&(t=function(e) {
        ...
        let t; return t=e.ajax(a).always(h.event.xhr.always).done(h.event.xhr.done).fail(h.event.xhr.fail), h.verbose('Created server request', t, a), t;
      }}, set: {error: function() {
        ...
        let t; return (t=v.beforeSend.call(E, v))&&(t.success!==i&&(h.debug('Legacy success callback detected', t), h.error(C.legacyParameters, t.success), t.onSuccess=t.success), t.failure!==i&&(h.debug('Legacy failure callback detected', t), h.error(C.legacyParameters, t.failure), t.onFailure=t.failure), t.complete!==i&&(h.debug('Legacy complete callback detected', t), h.error(C.legacyParameters, t.complete), t.onComplete=t.complete)), t===i&&h.error(C.noReturnedValue), !1===t?t:t!==i?e.extend(!0, {}, t):e.extend(!0, {}, v);
      }, urlEncodedValue: function(e) {
        const n=t.decodeURIComponent(e); const i=t.encodeURIComponent(e); return n!==e?(h.debug('URL value is already encoded, avoiding double encoding', e), e):(h.verbose('Encoding value using encodeURIComponent', e, i), i);
      }, defaultData: function() {
        const t={}; return e.isWindow(P)||(h.is.input()?t.value=T.val():h.is.form()||(t.text=T.text())), t;
      }, event: function() {
        ...
        const e=h.get.xhr(); e&&'resolved'!==e.state()&&(h.debug('Cancelling API request'), e.abort());
      }, reset: function() {
        ...
        let t; let n; v.performance&&(n=(t=(new Date).getTime())-(s||t), s=t, l.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Execution Time': n})), clearTimeout(h.performance.timer), h.performance.timer=setTimeout(h.performance.display, 500);
      }, display: function() {
        let t=v.name+':'; let n=0; s=!1, clearTimeout(h.performance.timer), e.each(l, function(e, t) {
          n+=t['Execution Time'];
        }), t+=' '+n+'ms', r&&(t+=' \''+r+'\''), (console.group!==i||console.table!==i)&&l.length>0&&(console.groupCollapsed(t), console.table?console.table(l):e.each(l, function(e, t) {
          console.log(t.Name+': '+t['Execution Time']+'ms');
        }), console.groupEnd()), l=[];
      }}, invoke: function(t, n, a) {
        let r; let s; let l; let c=F; return n=n||d, a=P||a, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
  ...
  'use strict'; t=void 0!==t&&t.Math==Math?t:'undefined'!=typeof self&&self.Math==Math?self:Function('return this')(), e.fn.visibility=function(o) {
    let a; const r=e(this); const s=r.selector||''; let l=(new Date).getTime(); let c=[]; const u=arguments[0]; const d='string'==typeof u; const f=[].slice.call(arguments, 1); const m=r.length; let g=0; return r.each(function() {
      let r; let p; let h; let v; const b=e.isPlainObject(o)?e.extend(!0, {}, e.fn.visibility.settings, o):e.extend({}, e.fn.visibility.settings); const y=b.className; const x=b.namespace; const C=b.error; const w=b.metadata; const S='.'+x; const k='module-'+x; const T=e(t); const A=e(this); const R=e(b.context); let P=(A.selector, A.data(k)); const E=t.requestAnimationFrame||t.mozRequestAnimationFrame||t.webkitRequestAnimationFrame||t.msRequestAnimationFrame||function(e) {
        setTimeout(e, 0);
      }; const F=this; let O=!1; v={initialize: function() {
...
b.throttle?(clearTimeout(v.timer), v.timer=setTimeout(function() {
  ...
  R.triggerHandler('scrollchange'+S, [R.scrollTop()]);
        ...
        const e=A.data(w.src); e&&(v.verbose('Lazy loading image', e), b.once=!0, b.observeChanges=!1, b.onOnScreen=function() {
        ...
        const e=R.get(0)!==t&&R.css('overflow-y'); return 'auto'==e||'scroll'==e;
      }, horizontallyScrollableContext: function() {
        const e=R.get(0)!==t&&R.css('overflow-x'); return 'auto'==e||'scroll'==e;
      }}, refresh: function() {
        ...
        const o=v.get.elementCalculations(); if (t&&n)b.onPassed[t]=n; else {
...
o.bottomVisible||o.pixelsPassed>v.get.pixelsPassed(e)?v.execute(t, e):b.once||v.remove.occurred(t);
        ...
        const t=v.get.elementCalculations(); const n=e||b.onOnScreen; const o='onScreen'; if (e&&(v.debug('Adding callback for onScreen', e), b.onOnScreen=e), t.onScreen?v.execute(n, o):b.once||v.remove.occurred(o), e!==i) return t.onOnScreen;
      }, offScreen: function(e) {
        const t=v.get.elementCalculations(); const n=e||b.onOffScreen; const o='offScreen'; if (e&&(v.debug('Adding callback for offScreen', e), b.onOffScreen=e), t.offScreen?v.execute(n, o):b.once||v.remove.occurred(o), e!==i) return t.onOffScreen;
      }, passing: function(e) {
        const t=v.get.elementCalculations(); const n=e||b.onPassing; const o='passing'; if (e&&(v.debug('Adding callback for passing', e), b.onPassing=e), t.passing?v.execute(n, o):b.once||v.remove.occurred(o), e!==i) return t.passing;
      }, topVisible: function(e) {
        const t=v.get.elementCalculations(); const n=e||b.onTopVisible; const o='topVisible'; if (e&&(v.debug('Adding callback for top visible', e), b.onTopVisible=e), t.topVisible?v.execute(n, o):b.once||v.remove.occurred(o), e===i) return t.topVisible;
      }, bottomVisible: function(e) {
        const t=v.get.elementCalculations(); const n=e||b.onBottomVisible; const o='bottomVisible'; if (e&&(v.debug('Adding callback for bottom visible', e), b.onBottomVisible=e), t.bottomVisible?v.execute(n, o):b.once||v.remove.occurred(o), e===i) return t.bottomVisible;
      }, topPassed: function(e) {
        const t=v.get.elementCalculations(); const n=e||b.onTopPassed; const o='topPassed'; if (e&&(v.debug('Adding callback for top passed', e), b.onTopPassed=e), t.topPassed?v.execute(n, o):b.once||v.remove.occurred(o), e===i) return t.topPassed;
      }, bottomPassed: function(e) {
        const t=v.get.elementCalculations(); const n=e||b.onBottomPassed; const o='bottomPassed'; if (e&&(v.debug('Adding callback for bottom passed', e), b.onBottomPassed=e), t.bottomPassed?v.execute(n, o):b.once||v.remove.occurred(o), e===i) return t.bottomPassed;
      }, passingReverse: function(e) {
        const t=v.get.elementCalculations(); const n=e||b.onPassingReverse; const o='passingReverse'; if (e&&(v.debug('Adding callback for passing reverse', e), b.onPassingReverse=e), t.passing?b.once||v.remove.occurred(o):v.get.occurred('passing')&&v.execute(n, o), e!==i) return !t.passing;
      }, topVisibleReverse: function(e) {
        const t=v.get.elementCalculations(); const n=e||b.onTopVisibleReverse; const o='topVisibleReverse'; if (e&&(v.debug('Adding callback for top visible reverse', e), b.onTopVisibleReverse=e), t.topVisible?b.once||v.remove.occurred(o):v.get.occurred('topVisible')&&v.execute(n, o), e===i) return !t.topVisible;
      }, bottomVisibleReverse: function(e) {
        const t=v.get.elementCalculations(); const n=e||b.onBottomVisibleReverse; const o='bottomVisibleReverse'; if (e&&(v.debug('Adding callback for bottom visible reverse', e), b.onBottomVisibleReverse=e), t.bottomVisible?b.once||v.remove.occurred(o):v.get.occurred('bottomVisible')&&v.execute(n, o), e===i) return !t.bottomVisible;
      }, topPassedReverse: function(e) {
        const t=v.get.elementCalculations(); const n=e||b.onTopPassedReverse; const o='topPassedReverse'; if (e&&(v.debug('Adding callback for top passed reverse', e), b.onTopPassedReverse=e), t.topPassed?b.once||v.remove.occurred(o):v.get.occurred('topPassed')&&v.execute(n, o), e===i) return !t.onTopPassed;
      }, bottomPassedReverse: function(e) {
        const t=v.get.elementCalculations(); const n=e||b.onBottomPassedReverse; const o='bottomPassedReverse'; if (e&&(v.debug('Adding callback for bottom passed reverse', e), b.onBottomPassedReverse=e), t.bottomPassed?b.once||v.remove.occurred(o):v.get.occurred('bottomPassed')&&v.execute(n, o), e===i) return !t.bottomPassed;
      }, execute: function(e, t) {
        const n=v.get.elementCalculations(); const i=v.get.screenCalculations(); (e=e||!1)&&(b.continuous?(v.debug('Callback being called continuously', t, n), e.call(F, n, i)):v.get.occurred(t)||(v.debug('Conditions met', t, n), e.call(F, n, i))), v.save.occurred(t);
        ...
        if (e) {
          const t=v.cache.occurred; t[e]!==i&&!0===t[e]&&(v.debug('Callback can now be called again', e), v.cache.occurred[e]=!1);
        ...
        let e; const t=v.get.scroll(); const n=v.get.lastScroll(); return e=t>n&&n?'down':t<n&&n?'up':'static', v.cache.direction=e, v.cache.direction;
      }, elementPosition: function() {
        const e=v.cache.element; const t=v.get.screenSize(); return v.verbose('Saving element position'), e.fits=e.height<t.height, e.offset=A.offset(), e.width=A.outerWidth(), e.height=A.outerHeight(), v.is.verticallyScrollableContext()&&(e.offset.top+=R.scrollTop()-R.offset().top), v.is.horizontallyScrollableContext()&&(e.offset.left+=R.scrollLeft-R.offset().left), v.cache.element=e, e;
      }, elementCalculations: function() {
        const e=v.get.screenCalculations(); const t=v.get.elementPosition(); return b.includeMargin?(t.margin={}, t.margin.top=parseInt(A.css('margin-top'), 10), t.margin.bottom=parseInt(A.css('margin-bottom'), 10), t.top=t.offset.top-t.margin.top, t.bottom=t.offset.top+t.height+t.margin.bottom):(t.top=t.offset.top, t.bottom=t.offset.top+t.height), t.topPassed=e.top>=t.top, t.bottomPassed=e.top>=t.bottom, t.topVisible=e.bottom>=t.top&&!t.topPassed, t.bottomVisible=e.bottom>=t.bottom&&!t.bottomPassed, t.pixelsPassed=0, t.percentagePassed=0, t.onScreen=(t.topVisible||t.passing)&&!t.bottomPassed, t.passing=t.topPassed&&!t.bottomPassed, t.offScreen=!t.onScreen, t.passing&&(t.pixelsPassed=e.top-t.top, t.percentagePassed=(e.top-t.top)/t.height), v.cache.element=t, v.verbose('Updated element calculations', t), t;
      }, screenCalculations: function() {
        const e=v.get.scroll(); return v.save.direction(), v.cache.screen.top=e, v.cache.screen.bottom=e+v.cache.screen.height, v.cache.screen;
      }, screenSize: function() {
        ...
        const t=v.get.elementCalculations(); return e.search('%')>-1?t.height*(parseInt(e, 10)/100):parseInt(e, 10);
      }, occurred: function(e) {
        ...
        let t; let n; b.performance&&(n=(t=(new Date).getTime())-(l||t), l=t, c.push({'Name': e[0], 'Arguments': [].slice.call(e, 1)||'', 'Element': F, 'Execution Time': n})), clearTimeout(v.performance.timer), v.performance.timer=setTimeout(v.performance.display, 500);
      }, display: function() {
        let t=b.name+':'; let n=0; l=!1, clearTimeout(v.performance.timer), e.each(c, function(e, t) {
          n+=t['Execution Time'];
        }), t+=' '+n+'ms', s&&(t+=' \''+s+'\''), (console.group!==i||console.table!==i)&&c.length>0&&(console.groupCollapsed(t), console.table?console.table(c):e.each(c, function(e, t) {
          console.log(t.Name+': '+t['Execution Time']+'ms');
        }), console.groupEnd()), c=[];
      }}, invoke: function(t, n, o) {
        let r; let s; let l; let c=P; return n=n||f, o=F||o, 'string'==typeof t&&c!==i&&(t=t.split(/[\. ]/), r=t.length-1, e.each(t, function(n, o) {
          const a=n!=r?o+t[n+1].charAt(0).toUpperCase()+t[n+1].slice(1):t; if (e.isPlainObject(c[a])&&n!=r)c=c[a]; else {
